...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
 ...
 <tr>
  ...
  <tr>
   ...
   <tr>
    ...
    <td ><bean:write name="accessoriesRequisitionBean" scope="request" property="isCharges"/></td>
 </tr>
 <tr>
 ...
 <tr>
    ...
    <td ><bean:write name="accessoriesRequisitionBean" scope="request" property="expressName"/></td>
 </tr>
  <tr>
 ...
 <tr>
    ...
    <td colspan="3"><bean:write name="accessoriesRequisitionBean" scope="request" property="isAgree"/></td>
 ...
 <tr>
    ...
    <td style="width: 35%"><bean:write name="accessoriesRequisitionBean" scope="request" property="ckiswc"/></td>
    <td class="wordtd">出库办理意见:</td>
    <td><bean:write name="accessoriesRequisitionBean" scope="request" property="ckrem"/></td>
 </tr>
 <tr>
