...
<br>
<html:errors/>
<html:form action="/accessoriesRequisitionAction.do?method=toModify" enctype="multipart/form-data">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
 ...
 <tr>
    ...
    <a style="cursor:hand;text-decoration: underline;color: blue;" onclick="downloadFile('${accessoriesRequisitionBean.oldImage}')">查看</a>
    </td>
 </tr>
 <tr>
    ...
    <bean:define id="newImage" name="accessoriesRequisitionBean" scope="request" property="newImage"></bean:define>
      ...
      <a style="cursor:hand;text-decoration: underline;color: blue;" onclick="downloadFile('${accessoriesRequisitionBean.newImage}')">查看</a>
    </logic:notEmpty>
    <logic:empty name="accessoriesRequisitionBean" property="newImage">
      <html:file property="newfile" styleClass="default_input" size="30"/>
      <font color="red">*</font>
    </logic:empty>
 </td>
