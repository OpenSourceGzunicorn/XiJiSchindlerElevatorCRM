...
<html:form action="/ServeTable.do">
	<table>
		<tr >
		   ...
		   <td><html:select property="property(maintDivision)" >
...
<br>	 
	 <table:table id="guiAccessoriesRequisition" name="accessoriesRequisitionReturnList">
		<logic:iterate id="element" name="accessoriesRequisitionReturnList">
			...
			<table:define id="c_appNo">
			 ...
			 <a href="<html:rewrite page='/accessoriesRequisitionReturnAction.do'/>?method=toPrepareUpdateRecord&id=<bean:write name="element"  property="appNo"/>">
