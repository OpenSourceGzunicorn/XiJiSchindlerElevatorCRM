...
<br>
<html:errors/>
<html:form action="/accessoriesRequisitionReturnAction.do?method=toUpdateRecord">
 ...
 <tr>
    ...
    <logic:present name="newimglist">
	    <logic:iterate id="ele2" name="invoiceImagelist" indexId="eid2">
	    	<a style="cursor:hand;text-decoration: underline;color: blue;" onclick="downloadFile('${ele2.filePath}${ele2.newFileName}')">开票信息${eid2+1 }</a>
	    </logic:iterate>
    </logic:present>
    </td>
 </tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
 ...
 <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
  <tr>
    ...
    <td>
    	<html:select name="accessoriesRequisitionBean" property="jjReturn" styleId="jjReturn"> 
          <html:option value=""><bean:message key="pageword.pleaseselect"/></html:option>
          <html:option value="Y">已退回</html:option>
          <html:option value="N">未退回</html:option>
 ...
 <tr>
    ...
    <td colspan="3">
		<html:textarea name="accessoriesRequisitionBean" property="jjResult" styleId="jjResult" rows="3" cols="100" styleClass="default_textarea"></html:textarea>
		<font color=red>*</font>
    </td>
 </tr>
 </table>
