...
function returnMethod(){
  	 window.location = '<html:rewrite page="/FaultProcessSearchAction.do"/>?method=toSearchRecord';
 }

//保存
function saveMethod(){
	document.FaultProcessForm.isreturn.value = "N";
    document.FaultProcessForm.submit();
}

//保存返回
function saveReturnMethod(){
document.FaultProcessForm.isreturn.value = "Y";
document.FaultProcessForm.submit();
