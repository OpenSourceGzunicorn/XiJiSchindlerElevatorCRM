...
<br>
	 <table:table id="guiTechnologySupport" name="technologySupportMaintMinisterList">
		<logic:iterate id="element" name="technologySupportMaintMinisterList">
			...
			<html:hidden  name="element" property="mmprocessPeople"/>
			</table:define>
			 <table:define id="c_singleNo">
			 <a href="<html:rewrite page='/technologySupportMaintMinisterAction.do'/>?method=toPrepareUpdateRecord&id=<bean:write name="element"  property="billno"/>">
