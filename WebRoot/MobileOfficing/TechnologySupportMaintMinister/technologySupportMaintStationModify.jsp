...
<br>
<html:errors/>
<html:form action="/technologySupportMaintMinisterAction.do?method=toUpdateRecord">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
 ...
 <tr>
    ...
    <td style="width: 30%"> <html:select name="technologySupportBean" property="mmisResolve">
 ...
 <tr>
    ...
    <td colspan="3" ><html:textarea name="technologySupportBean" property="mmprocessRem" styleId="mmprocessRem" rows="3" cols="100" styleClass="default_textarea"></html:textarea></td>
    
 </tr>
 <tr>
    <td class="wordtd"><bean:message key="technologySupport.mmProcessDate"/>:</td>
    <td colspan="3" ><bean:write name="technologySupportBean" scope="request" property="mmprocessDate"/>
    <html:hidden name="technologySupportBean" property="mmprocessDate"/></td>
 </tr>
  </table>
