...
<br>
	 <table:table id="guiTechnologySupport" name="technologySupportMaintStationList">
		<logic:iterate id="element" name="technologySupportMaintStationList">
			<table:define id="c_cb">
			 ...
			 <bean:define id="billno" name="element" property="billno" />  
			  ...
			  <html:hidden name="element" property="msprocessPeople"/>
			</table:define>
			<table:define id="c_singleNo">
			 <a href="<html:rewrite page='/technologySupportMaintStationAction.do'/>?method=toPrepareUpdateRecord&id=<bean:write name="element"  property="billno"/>">
