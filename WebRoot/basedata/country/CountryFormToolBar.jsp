...
function returnMethod(){
  	 window.location = '<html:rewrite page="/countrySearchAction.do"/>?method=toSearchRecord';
 }

//保存
function saveMethod(){
  if(validateCountryForm(document.all.item("countryForm"))==true){
	document.countryForm.isreturn.value = "N";
...
function saveReturnMethod(){
 if(validateCountryForm(document.all.item("countryForm"))==true){
document.countryForm.isreturn.value = "Y";
document.countryForm.submit();
 }
}
