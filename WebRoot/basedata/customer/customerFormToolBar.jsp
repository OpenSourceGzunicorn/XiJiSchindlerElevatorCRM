...
function returnMethod(){
  window.location = '<html:rewrite page="/customerSearchAction.do"/>?method=toSearchRecord';
}

//保存
function saveMethod(){
  if(validateCustomerForm(document.all.item("customerForm"))==true){
	  var errstr=checkkpxx();
	  if(errstr==""){
...
function openNewWindow(){
  openwindowReturnValueCustomer('query/Search.jsp?path=<html:rewrite page="/customerSearchAction.do" />?method=toPrincipalSelectList','customerForm','principalId','principalName','principalPhone');
}
