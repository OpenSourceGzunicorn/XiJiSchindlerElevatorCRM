...
function returnMethod(){
  window.location = '<html:rewrite page="/entrustCustomerSearchAction.do"/>?method=toSearchRecord';
}

//保存
function saveMethod(){
  if(validateCustomerForm(document.all.item("entrustCustomerForm"))==true){
    document.entrustCustomerForm.isreturn.value = "N";
    document.entrustCustomerForm.submit();
  }
}
...
function saveReturnMethod(){
  if(validateCustomerForm(document.all.item("entrustCustomerForm"))==true){
    document.entrustCustomerForm.isreturn.value = "Y";
    document.entrustCustomerForm.submit();
  }  
}

function openNewWindow(){
  openwindowReturnValueCustomer('query/Search.jsp?path=<html:rewrite page="/entrustCustomerSearchAction.do" />?method=toPrincipalSelectList','customerForm','principalId','principalName','principalPhone');
}
