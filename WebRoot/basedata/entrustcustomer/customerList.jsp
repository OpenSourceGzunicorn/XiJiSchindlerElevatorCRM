...
<html:form action="/ServeTable.do">
	...
	<br>
	<table:table id="guiCustomer" name="entrustCustomerList">
		<logic:iterate id="element" name="entrustCustomerList">
			...
			<table:define id="c_companyId">
				<a href="<html:rewrite page='/entrustCustomerAction.do'/>?method=toDisplayRecord&id=<bean:write name="element"  property="companyId"/>">
