...
function returnMethod(){
  window.location = '<html:rewrite page="/hotlineFaultTypeSearchAction.do"/>?method=toSearchRecord';
}

//保存
function saveMethod(){
  if(validateHotlineFaultTypeForm(document.all.item("hotlineFaultTypeForm"))==true){
    document.hotlineFaultTypeForm.isreturn.value = "N";
    document.hotlineFaultTypeForm.submit();
  }
}
...
function saveReturnMethod(){
  if(validateHotlineFaultTypeForm(document.all.item("hotlineFaultTypeForm"))==true){
    document.hotlineFaultTypeForm.isreturn.value = "Y";
    document.hotlineFaultTypeForm.submit();
  }  
}

function openNewWindow(){
  openwindowReturnValueCustomer('query/Search.jsp?path=<html:rewrite page="/hotlineFaultTypeSearchAction.do" />?method=toPrincipalSelectList','hotlineFaultTypeForm','hftId','hftDesc','enabledFlag');
}
