...
function returnMethod(){
  window.location = '<html:rewrite page="/invoiceTypeSearchAction.do"/>?method=toSearchRecord';
}

//保存
function saveMethod(){
  if(validateInvoiceTypeForm(document.all.item("invoiceTypeForm"))==true){
    document.invoiceTypeForm.isreturn.value = "N";
    document.invoiceTypeForm.submit();
  }
}
...
function saveReturnMethod(){
  if(validateInvoiceTypeForm(document.all.item("invoiceTypeForm"))==true){
    document.invoiceTypeForm.isreturn.value = "Y";
    document.invoiceTypeForm.submit();
  }  
}

function openNewWindow(){
  openwindowReturnValueCustomer('query/Search.jsp?path=<html:rewrite page="/invoiceTypeSearchAction.do" />?method=toPrincipalSelectList','invoiceTypeForm','inTypeId','inTypeName','enabledFlag');
}
