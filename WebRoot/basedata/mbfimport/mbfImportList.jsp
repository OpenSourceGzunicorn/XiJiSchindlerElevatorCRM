...
<html:hidden property="property(genReport)" styleId="genReport" />
  ...
  <br>
  <table:table id="guiMbfImport" name="mbfImporModifyList">
    <logic:iterate id="element" name="mbfImporModifyList">
      ...
      <table:define id="c_mbfMoney">
        <bean:write name="element" property="mbfMoney" />
      </table:define>
