...
function returnMethod(){
	window.location = '<html:rewrite page="/nzjImportSearchAction.do"/>?method=toSearchRecord';
}
  ...
  if(fileName==""){
    ...
    if(filestr!="xlsx"){
      alert("请选择EXCEL2007或以上版本文件。");
    	...
    	if(confirm("若存在相同的 维保分部，维保站，年份 将被替换，确认上传？")){
...
function downLoadMethod(){
  window.open("<html:rewrite page='/uploadFile/nzjImportInfo.xlsx'/>");
}
