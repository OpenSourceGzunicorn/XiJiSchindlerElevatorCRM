...
function returnMethod(){
  window.location = '<html:rewrite page="/receivablesNameSearchAction.do"/>?method=toSearchRecord';
}

//保存
function saveMethod(){
  if(validateReceivablesNameForm(document.all.item("receivablesNameForm"))==true){
    document.receivablesNameForm.isreturn.value = "N";
    document.receivablesNameForm.submit();
  }
}
...
function saveReturnMethod(){
  if(validateReceivablesNameForm(document.all.item("receivablesNameForm"))==true){
    document.receivablesNameForm.isreturn.value = "Y";
    document.receivablesNameForm.submit();
  }  
}

function openNewWindow(){
  openwindowReturnValueCustomer('query/Search.jsp?path=<html:rewrite page="/receivablesNameSearchAction.do" />?method=toPrincipalSelectList','receivablesNameForm','recId','recName','enabledFlag');
}
