...
<html:hidden property="property(genReport)" styleId="genReport" />
  ...
  <br>
  <table:table id="guiSbzcImport" name="sbzcImporModifyList">
    <logic:iterate id="element" name="sbzcImporModifyList">
      ...
      <table:define id="c_sbzcMoney">
        <bean:write name="element" property="sbzcMoney" />
      </table:define>
