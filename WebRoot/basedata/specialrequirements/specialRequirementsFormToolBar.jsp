...
function returnMethod(){
  window.location = '<html:rewrite page="//specialRequirementsSearchAction.do"/>?method=toSearchRecord';
}
...
function saveMethod(){
    ...
    document.handoverElevatorSpecialClaimForm.isreturn.value = "N";
    document.handoverElevatorSpecialClaimForm.submit();
}
...
function saveReturnMethod(){
    ...
    document.handoverElevatorSpecialClaimForm.isreturn.value = "Y";
    document.handoverElevatorSpecialClaimForm.submit();
