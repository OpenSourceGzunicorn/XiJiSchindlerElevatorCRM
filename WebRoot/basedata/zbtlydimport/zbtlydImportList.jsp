...
<html:hidden property="property(genReport)" styleId="genReport" />
  ...
  <br>
  <table:table id="guiZbtlydImport" name="zbtlydImporModifyList">
    <logic:iterate id="element" name="zbtlydImporModifyList">
      ...
      <table:define id="c_totalnum">
        <bean:write name="element" property="totalnum" />
      </table:define>
      <table:define id="c_daynum">
        <bean:write name="element" property="daynum" />
      </table:define>
