...
strFrame='<link rel="stylesheet" type="text/css" href="/XJSCRM/common/css/CalendarAndTime.css">';
...
function setday(tt,obj,showDateTime) //主调函数
{
...
function meizzDayClick(n,ex)  //点击显示框选取日期，主输入函数*************
{
  ...
  if (!n) {//outObject.value="";
    return;}
  if ( n < 10){n = "0" + n;}
  hiddenTimeVal= yy + "-" + mm + "-" + n ; //注：在这里你可以输出改成你想要的格式
