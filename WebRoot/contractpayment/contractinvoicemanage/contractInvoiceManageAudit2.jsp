...
<body>
  <html:errors/>
  <html:form action="/contractInvoiceManageAudit2Action.do?method=toAuditRecord">
...
<html:hidden name="contractInvoiceManageBean" property="auditStatus2"/>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
    	...
    	<tr>
    		...
    		<td colspan="3">
    		<html:textarea property="auditRem2" rows="3" cols="100" styleClass="default_textarea"/>
    		</td>
    	</tr>
    </table>
    <br/>
