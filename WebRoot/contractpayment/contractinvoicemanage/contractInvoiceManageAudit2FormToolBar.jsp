...
function returnMethod(){
  window.location = '<html:rewrite page="/contractInvoiceManageAudit2SearchAction.do"/>?method=toSearchRecordAudit';
}
...
function saveMethod(){
    ...
    document.contractInvoiceManageForm.auditStatus2.value = "Y";
...
function saveReturnMethod(){
      ...
      document.contractInvoiceManageForm.auditStatus2.value = "N";
      document.contractInvoiceManageForm.submit();
}
