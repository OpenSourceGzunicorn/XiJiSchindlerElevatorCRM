...
<body>
  <html:errors/>
  <html:form action="/contractInvoiceManageAudit3Action.do?method=toAuditRecord">
...
<html:hidden name="contractInvoiceManageBean" property="auditStatus3"/>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
    	...
    	<tr>
    		<td class="wordtd">审核意见：</td>
    		<td colspan="3">
    		<html:textarea property="auditRem3" rows="3" cols="100" styleClass="default_textarea"/>
    		</td>
    	</tr>
    </table>
  </html:form>
