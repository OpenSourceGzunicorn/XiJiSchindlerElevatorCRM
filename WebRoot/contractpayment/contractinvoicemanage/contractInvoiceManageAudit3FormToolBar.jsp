...
function returnMethod(){
  window.location = '<html:rewrite page="/contractInvoiceManageAudit3SearchAction.do"/>?method=toSearchRecordAudit';
}
...
function saveMethod(){
  if(checkColumnInput(contractInvoiceManageForm)){
    ...
    document.contractInvoiceManageForm.auditStatus3.value = "Y";
...
function saveReturnMethod(){
  ...
  if(checkColumnInput(contractInvoiceManageForm)){
      ...
      document.contractInvoiceManageForm.auditStatus3.value = "N";
      document.contractInvoiceManageForm.submit();
    } 
}
