...
function returnMethod(){
  window.location = '<html:rewrite page="/contractInvoiceManageAudit4SearchAction.do"/>?method=toSearchRecordAudit';
}
...
function saveMethod(){
  if(checkColumnInput(contractInvoiceManageForm)){
    ...
    document.contractInvoiceManageForm.auditStatus4.value = "Y";
...
function saveReturnMethod(){
  ...
  if(checkColumnInput(contractInvoiceManageForm)){
      ...
      document.contractInvoiceManageForm.auditStatus4.value = "N";
      document.contractInvoiceManageForm.submit();
    } 
}
