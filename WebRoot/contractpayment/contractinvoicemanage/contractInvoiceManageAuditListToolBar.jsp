...
function modifyMethod2(id,auditStatus){
	if(auditStatus == "N" || auditStatus=="X"){
		window.location = '<html:rewrite page="/contractInvoiceManageAction.do"/>?id='+id+'&method=toPrepareAuditRecord';
	}else{
		window.location = '<html:rewrite page="/contractInvoiceManageAction.do"/>?id='+id+'&method=toAuditDisplay';
	}
