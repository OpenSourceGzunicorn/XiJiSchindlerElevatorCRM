...
function returnMethod(){
  window.location = '<html:rewrite page="/contractParagraphAuditSearchAction.do"/>?method=toSearchRecordAudit';
}
...
function saveMethod(){
  if(checkColumnInput(contractParagraphManageForm)){
    ...
    document.contractParagraphManageForm.auditStatus.value = "Y";
...
function saveReturnMethod(){
  ...
  if(checkColumnInput(contractParagraphManageForm)){
      ...
      document.contractParagraphManageForm.submitType.value = "R";
      document.contractParagraphManageForm.auditStatus.value = "N";
      document.contractParagraphManageForm.submit();
    } 
}
