...
function returnMethod(){
  window.location = '<html:rewrite page="/proContractArfeeMasterSearchAction.do"/>?method=toSearchRecordAudit';
}
...
function saveMethod(){
  if(checkColumnInput(proContractArfeeMasterForm)){
    ...
    document.proContractArfeeMasterForm.auditStatus.value = "Y";
...
function saveReturnMethod(){
  inputTextTrim();  
  if(checkColumnInput(proContractArfeeMasterForm)){
      document.proContractArfeeMasterForm.isreturn.value = "Y";
      document.proContractArfeeMasterForm.submitType.value = "R";
      document.proContractArfeeMasterForm.auditStatus.value = "N";
      document.proContractArfeeMasterForm.submit();
    } 
}
