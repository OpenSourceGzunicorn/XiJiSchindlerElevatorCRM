...
/* 	var submitType=getVal("submitType",index);//提交状态	
	...
	toDoMethod(index,"toPrepareWarnRecord","","<bean:message key="javascript.role.alert.jilu"/>");
}
...
window.onload=function(){
	...
	for(var i=0;i<edates.length;i++){
		...
		//alert(edateArray[0]+","+edateArray[1]+","+edateArray[2]);
		var edate=new Date()
		edate.setFullYear(edateArray[0],edateArray[1]-1,edateArray[2]);
		edate.setMonth(edate.getMonth()-1);
		//alert(edate.getFullYear()+","+edate.getMonth());
