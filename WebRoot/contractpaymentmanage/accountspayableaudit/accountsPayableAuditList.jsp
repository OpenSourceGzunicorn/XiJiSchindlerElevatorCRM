...
<html:hidden property="property(genReport)" styleId="genReport" />
  ...
  <br>
  <table:table id="guiAccountsPayableManage" name="accountsPayableAuditList">
    <logic:iterate id="element" name="accountsPayableAuditList">
      ...
      <table:define id="c_jnlNo">
       <!-- <a href="<html:rewrite page='/accountsPayableAuditAction.do'/>?method=toDisplayRecord&id=<bean:write name="element"  property="jnlNo"/>"> --> 
