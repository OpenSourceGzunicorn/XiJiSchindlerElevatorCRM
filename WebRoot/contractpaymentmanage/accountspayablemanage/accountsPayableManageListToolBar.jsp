...
//新建
function addMethod(){
	window.location = '<html:rewrite page="/accountsPayableManageSearchAction.do"/>?method=toSearchNext';
}
...
function toDoMethod(index,method,params,alertMsg){
	if(index >= 0){	
		window.location = '<html:rewrite page="/accountsPayableManageAction.do"/>?id='+getVal('ids',index)+'&method='+method+params;
