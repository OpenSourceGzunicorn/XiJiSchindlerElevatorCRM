...
function CreateToolBar(){
  ...
  <%-- 是否有可写的权限--%>
  <logic:equal name="<%=SysConfig.TOOLBAR_RIGHT%>" property="ncontractpaymentenquiry" value="Y"> 
  </logic:equal>
...
function toDoMethod(index,method,params,alertMsg){
	if(index >= 0){	
		window.location = '<html:rewrite page="/contractPaymentEnquiryAction.do"/>?id='+getVal('ids',index)+'&method='+method+params;
