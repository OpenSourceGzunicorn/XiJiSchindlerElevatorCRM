  ...
  if(serveTableForm.ids)
  {
    ...
    if(l)
    {
      for(i=0;i<l;i++)
      {
        ...
        {
          window.location = '<html:rewrite page="/paymentManageAction.do"/>?jnlNo='+document.serveTableForm.ids[i].value+'&method=toPrepareAddRecord';
          return;       
        }
      }
      if(l >0)
    ...
    {  
      window.location = '<html:rewrite page="/paymentManageAction.do"/>?jnlNo='+document.serveTableForm.ids.value+'&method=toPrepareAddRecord';
      return; 
    }
    else
    {
