...
function modifyMethod(){
	var index = getIndex();	
	var auditStatus = document.getElementsByName("auditStatus2");
	toDoMethod(index,"toPrepareAddRecord","&auditStatus2="+auditStatus[index].value,"请选择你要审核的记录！");
}
...
function toDoMethod(index,method,params,alertMsg){
	...
	if(index >= 0){
		window.location = '<html:rewrite page="/ContractTransferManagerAuditAction.do"/>?id='+getVal('ids',index)+'&method='+method+params;	
