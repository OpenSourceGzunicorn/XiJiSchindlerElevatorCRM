...
function addFromQuoteMethod(){
  window.location = '<html:rewrite page="/freeFittingCostsManageAction.do"/>?method=toPrepareAddRecord';
}
...
function toDoMethod(index,method,params,alertMsg){
	if(index >= 0){	
		window.location = '<html:rewrite page="/freeFittingCostsManageAction.do"/>?id='+document.getElementsByName("ids")[index].value+'&method='+method+params;
