...
<br>
<html:errors/>
<html:form action="/MaintFMinisterFollowAction.do?method=toUpdateRecord">
...
<tr>
			...
			<td style="width: 35%">${cvpdbean.fMinisterFollowDate}<input type="hidden" name="fMinisterFollowDate" id="fMinisterFollowDate" value="${cvpdbean.fMinisterFollowDate}"></td>
		</tr>
		<tr><td class="wordtd">维保分部长跟进办法</td>
			<td colspan="3"><textarea rows="2" cols="80" name="fministerFollowRem" id="fministerFollowRem"></textarea></td>
		</tr>
