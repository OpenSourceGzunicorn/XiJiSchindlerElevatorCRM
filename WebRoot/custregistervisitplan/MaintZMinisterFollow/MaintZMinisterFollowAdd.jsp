...
<br>
<html:errors/>
<html:form action="/MaintZMinisterFollowAction.do?method=toUpdateRecord">
...
<tr>
			...
			<td style="width: 35%">${cvpdbean.managerFollowDate}</td>
		</tr>
		<tr><td class="wordtd">维保经理跟进办法</td>
			<td colspan="3">${cvpdbean.managerFollowRem}</td>
		</tr>
...
<tr>
			...
			<td style="width: 35%">${cvpdbean.zMinisterFollowDate }<input type="hidden" name="zministerFollowDate" id="zministerFollowDate" value="${cvpdbean.zMinisterFollowDate }"></td>
		</tr>
		<tr><td class="wordtd">维保总部长跟进办法</td>
			<td colspan="3"><textarea rows="2" cols="80" name="zministerFollowRem" id="zministerFollowRem"></textarea></td>
		</tr>
