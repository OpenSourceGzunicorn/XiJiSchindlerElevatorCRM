...
function CreateToolBar(){
  ...
  <%-- 是否有可写的权限--%>
  <logic:equal name="<%=SysConfig.TOOLBAR_RIGHT%>" property="nMaintZMinisterFollow" value="Y"> 
...
function returnMethod(){
       ...
       window.location = '<html:rewrite page="/MaintZMinisterFollowSearchAction.do"/>?method=toSearchRecord';
...
function saveMethod(){
		 ...
		 /*  document.MaintManagerFollowForm.isreturn.value = "N"; */
	  		document.MaintZMinisterFollowForm.submit(); 
}
