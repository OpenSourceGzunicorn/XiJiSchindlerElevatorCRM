...
<html:form action="/ServeTable.do">
	<table>
		...
		<tr>
			<td><bean:message key="customerVisitPlan.isVisit" />:</td>
				<td><html:select property="property(isVisit)">
					<html:option value="">
			...
			<td>&nbsp;&nbsp;…Û∫À◊¥Ã¨:</td>
				<td><html:select property="property(auditStatus)">
					<html:option value="">
						<bean:message key="pageword.all" />
					</html:option>
					<html:option value="Y">
	...
	<br>
	<table:table id="guiCustomerVisitFeedbackAudit"
		name="customerVisitFeedbackAuditList">
		<logic:iterate id="element" name="customerVisitFeedbackAuditList">
			...
			<table:define id="c_isVisit">
				...
				<html:hidden name="element" property="isVisit"/>
			</table:define>
			<table:tr />
		</logic:iterate>
	</table:table>
