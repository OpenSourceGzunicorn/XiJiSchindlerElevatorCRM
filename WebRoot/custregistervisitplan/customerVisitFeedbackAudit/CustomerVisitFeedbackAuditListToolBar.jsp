...
function CreateToolBar(){
  ...
  AddToolBarItemEx("UpdateBtn","../../common/images/toolbar/edit.gif","","","审 核","65","1","updateMethod()");  
  </logic:equal>
...
function toDoMethod(index,method,params){
		window.location = '<html:rewrite page="/customerVisitFeedbackAuditAction.do"/>?id='+getVal('ids',index)+'&method='+method+params;
}
