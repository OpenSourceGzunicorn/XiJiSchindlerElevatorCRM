...
<br>
<html:errors/>
<html:form action="/customerVisitFeedbackAuditAction.do?method=toUpdateRecord">
<html:hidden property="id" value="${cvpdbean.jnlno}" />
	...
	<table width="100%" class="tb">
		...
		<tr><td class="wordtd">驳回日期</td>
			...
			<td><textarea rows="2" cols="30" name="bhRem" id="bhRem"></textarea></td>
		</tr>
		</table>
		<br/>
...
<tr>
			...
			<td style="width: 35%">${cvpdbean.auditDate }<input type="hidden" name="auditDate" id="auditDate" value="${cvpdbean.auditDate }"> </td>
		</tr>
		<tr><td class="wordtd">审核意见</td>
			<td colspan="3"><textarea rows="2" cols="80" name="auditRem" id="auditRem"></textarea></td>
		</tr>
</table>
