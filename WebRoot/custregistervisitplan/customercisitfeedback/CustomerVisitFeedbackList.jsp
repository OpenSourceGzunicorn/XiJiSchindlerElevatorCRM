...
<html:form action="/ServeTable.do">
	<table>
		...
		<tr>
			...
			<td>是否提交:</td>
				<td><html:select property="property(isSubmitType)">
					<html:option value="">
	...
	<br>
	<table:table id="guiCustomerVisitFeedback"
		name="customerVisitFeedbackList">
		<logic:iterate id="element" name="customerVisitFeedbackList">
