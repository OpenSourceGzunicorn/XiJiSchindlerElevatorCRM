...
<br>
<html:errors/>
<logic:present name="cvpdbean">
<html:hidden property="id" value="${cvpdbean.jnlno}" />
	<table width="100%" class="tb">
	<tr>
		<td class="wordtd" >拜访人 ： </td>
			<td style="width: 26%"><bean:write name="cvpdbean" property="visitStaff"></bean:write>
	...
	<table width="100%" class="tb">
		...
		<tr>
			...
			<td style="width: 26%"><bean:write name="cvpmbean" property="maintDivision"></bean:write></td>
...
<table width="100%" class="tb">
	<tr>
		...
		<td style="width: 26%"><bean:write name="cvpdbean" property="visitPeople"/></td>
...
<tr>
		...
		<tr><td class="wordtd">审核意见</td>
			<td colspan="3">${cvpdbean.auditRem }</textarea></td>
		</tr>
</table>
<br>
<table class="dynamictable tb" width="100%" border="0" cellpadding="0" cellspacing="0">
