...
<br>
<html:errors/>
<html:form action="/custReturnRegisterAction.do?method=toUpdateRecord">
<html:hidden property="isreturn"/>
<logic:present name="custReturnRegisterMasterBean">
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
  <tr>
    
    <td  class="wordtd"><bean:message key="custreturnregister.contacts"/>:</td>
    <td style="width: 20%" class="inputtd"><bean:write name="custReturnRegisterMasterBean" scope="request" property="contacts"/>
    <input type="hidden" name="billno" value='<bean:write name="custReturnRegisterMasterBean" scope="request" property="billno" />'>
    <input type="hidden" id="isreturn2" value=""></td>
    </td>
    <td  class="wordtd"><bean:message key="custreturnregister.contactPhone"/>:</td>
    <td width="20%" class="inputtd"><bean:write name="custReturnRegisterMasterBean" scope="request" property="contactPhone"/></td>
  
    <td  class="wordtd">&nbsp;</td>
    <td ><html:hidden name="custReturnRegisterMasterBean" property="ministerHandle" /></td>
    </tr>
  <tr>
    <td  class="wordtd"><bean:message key="custreturnregister.operId"/>:</td>
    <td  class="inputtd"><bean:write name="custReturnRegisterMasterBean" scope="request" property="operId"/></td>
    <td  class="wordtd"><bean:message key="custreturnregister.operDate"/>:</td>
    <td  class="inputtd"><bean:write name="custReturnRegisterMasterBean" scope="request" property="operDate"/></td>
    <td  class="wordtd"><bean:message key="custreturnregisterhand.maintDivision"/>:</td>
    <td  class="inputtd"><bean:write name="custReturnRegisterMasterBean" scope="request" property="maintDivision"/></td>
  </tr>
  <tr>
...
<tr>
    ...
    <td class="inputtd"><html:textarea name="custReturnRegisterMasterBean" property="returnRem" rows="3" cols="142" styleClass="default_textarea"/></td>
</tr>
</table>
</logic:present>
</html:form>