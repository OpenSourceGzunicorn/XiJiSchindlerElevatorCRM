...
<html:errors />
<br>
<html:form action="/custReturnRegisterHandleAction.do">
	<table>
		<tr>
		   <%--  <td>
				&nbsp;&nbsp;
	...
	<logic:equal name="custReturnRegisterListSize" value="0">
			<TR class=noItems ><TD colSpan=13>没记录显示! </TD></TR>
	</logic:equal>
	<logic:notEqual name="custReturnRegisterListSize"  value="0">
	...
	<td><bean:write name="element" property="rem" /></td>
	</tr>	
	</logic:iterate>
	</logic:present>
