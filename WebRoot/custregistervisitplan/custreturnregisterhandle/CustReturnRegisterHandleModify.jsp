...
<br>
<html:errors/>
<html:form action="/custReturnRegisterHandleAction.do?method=toUpdateRecord">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
  <tr>
    ...
    <td width="20%"><bean:write name="custReturnRegisterMasterBean" scope="request" property="contacts"/>
        <input type="hidden" name="billno" value='<bean:write name="custReturnRegisterMasterBean" scope="request" property="billno" />'></td>
