...
<br>
<html:errors/>
<html:form action="/effectiveElevatorAction.do?method=toAddRecord">
...
<table width="100%" class="tb">
    ...
    <td width="80%"><html:text property="companyName"  maxlength="255" styleId="companyName" styleClass="default_input" size="50"/><font color="red">*</font>
    <%-- 
    <html:hidden property="companyId"  styleId="companyId"/> 
    <input type="button" value=".." onclick="openWindowAndReturnValue2('searchEffectiveElevatorAction')"/><font color="red">*</font>
    --%>
    </td>
  </tr>
   <tr>
    <td width="20%" class="wordtd">联系人:</td>
    <td width="80%"><html:text property="contacts" maxlength="255" styleId="contacts" styleClass="default_input"/><font color="red">*</font>
    </td>
  </tr>
   <tr>
    <td width="20%" class="wordtd">联系人电话:</td>
    <td width="80%"><html:text property="contactPhone" maxlength="255" styleId="contactPhone" styleClass="default_input"/><font color="red">*</font>
