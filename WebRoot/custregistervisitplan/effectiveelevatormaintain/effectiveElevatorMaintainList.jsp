...
<html:form action="/ServeTable.do">
	...
	<br>
	<table:table id="guiEffectiveElevatorMaintain" name="effectiveElevatorList">
		<logic:iterate id="element" name="effectiveElevatorList">
		...
		<table:define id="c_companyId">
				 <a href="<html:rewrite page='/effectiveElevatorAction.do'/>?method=toDisplayRecord&id=<bean:write name="element"  property="billno"/>"> 
