...
function returnMethod(){
	...
	if(isreturn=="2")
		...
		companyName=encodeURI(encodeURI(companyName));//使用URL编码
		window.location = '<html:rewrite page="/effectiveElevatorRegisterMasterAction.do"/>?id='+companyName+'&method=toHistoryDisplayRecord';
		}else
			{
...
function saveMethod(){
	var handle=document.getElementById("ministerHandle");	
	  ...
	  //alert(rowsToJSONArray("registerDetail","details"));
		  document.effectiveElevatorRegisterMasterForm.isreturn.value = "Y";
