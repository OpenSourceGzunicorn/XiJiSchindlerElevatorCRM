...
<html:errors />
<br>
<html:form action="/effectiveElevatorRegisterMinisterHandleAction.do">
	<table>
		<tr>
		    <td>
				&nbsp;&nbsp;
	...
	<td >
	  <bean:define id="companyName" name="element" property="companyName" />		
		<html:radio property="ids" styleId="ids" value="<%=companyName.toString()%>" />
