...
<br>
<html:errors/>
<html:form action="/lostElevatorRegisterMasterAction.do?method=toAddRecord">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
  <tr>
   <td nowrap="nowrap" class="wordtd"><bean:message key="custreturnregister.companyName"/>:</td>
    ...
    <html:hidden name="ele" property="companyId"/>
  ...
  <tr>
    ...
    <td colspan="4"><html:textarea property="rem" rows="4" cols="100" styleClass="default_textarea" style=" width: 100%"></html:textarea></td>
  </tr>
  <tr>
