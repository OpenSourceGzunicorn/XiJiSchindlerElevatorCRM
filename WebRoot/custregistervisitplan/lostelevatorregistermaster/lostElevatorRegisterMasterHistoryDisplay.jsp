...
<table width="100%" border="0" cellspacing="1" cellpadding="1" class="tableclass" >  
	...
	<logic:match name="custReturnRegisterHistoryListSize" value="0">
			<TR class=noItems ><TD colSpan=12>Ã»¼ÇÂ¼ÏÔÊ¾! </TD></TR>
	</logic:match>
	...
	<td>
		 <a href="<html:rewrite page='/lostElevatorRegisterMasterAction.do'/>?method=toDisplayRecord&id=<bean:write name="element"  property="billno"/>&isreturn=2">
