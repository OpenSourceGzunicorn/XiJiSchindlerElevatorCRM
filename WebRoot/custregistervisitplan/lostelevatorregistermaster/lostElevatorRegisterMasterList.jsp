...
<html:errors />
<br>
<html:form action="/lostElevatorRegisterMasterAction.do">
	<table>
		<tr>
		    <td>
				&nbsp;&nbsp;
			...
			<td>
			    <html:text property="companyName" styleClass="default_input" size="35"></html:text>			
			</td>		
			<td>
				&nbsp;&nbsp;
				<%-- <bean:message key="custreturnregister.contacts" /> --%>合同联系人
				:
			</td>
			<td>
			...
			<td>
				&nbsp;&nbsp;
				<%-- <bean:message key="custreturnregister.contacts" /> --%>合同联系人电话
				:
			</td>
			<td>
			...
			<td>
				<html:select property="maintDivision2">
	...
	<td rowspan="1" colspan="1" style="text-align: center;" nowrap="nowrap"><bean:message key="custreturnregister.reOrder" /></td>
	<td rowspan="1" colspan="1" style="text-align: center;" nowrap="nowrap"><bean:message key="custreturnregister.reMark" /></td>
	<td rowspan="1" colspan="1" style="text-align: center;" nowrap="nowrap"><bean:message key="custreturnregister.companyName" /></td>
	<td rowspan="1" colspan="1" style="text-align: center;" nowrap="nowrap"><bean:message key="custreturnregister.contacts" /></td>
	<td rowspan="1" colspan="1" style="text-align: center;" nowrap="nowrap"><bean:message key="custreturnregister.contactPhone" /></td>
	<td rowspan="1" colspan="1" style="text-align: center;" nowrap="nowrap"><bean:message key="custreturnregister.maxoperDate" /></td>
	<%-- <td rowspan="1" colspan="1" style="text-align: center;"><bean:message key="custreturnregister.isProblem" /></td>--%>
	<td rowspan="1" colspan="1" style="text-align: center;" nowrap="nowrap"><bean:message key="custreturnregister.isHandleResult" /></td> 
	<td rowspan="1" colspan="1" style="text-align: center;" nowrap="nowrap"><bean:message key="custreturnregister.isHandle" /></td>
	<td rowspan="1" colspan="1" style="text-align: center;" nowrap="nowrap"><bean:message key="custreturnregister.ministerHandle" /></td>		
	<td rowspan="1" colspan="1" style="text-align: center;" nowrap="nowrap"><bean:message key="custreturnregisterhand.maintDivision" /></td>	
	...
	<td >
	  <bean:define id="billno1" name="element" property="billno1" />		
	    ...
	    <input type="hidden" name="companyId" value='<bean:write name="element"  property="companyId"/>'>
	...
	<td>
	  ...
	  <logic:notEmpty name="element" property="billno">
		<a href="<html:rewrite page='/lostElevatorRegisterMasterAction.do'/>?method=toDisplayRecord&id=<bean:write name="element"  property="billno"/>">
			<bean:write name="element" property="reOrder" />
		</a>
	  </logic:notEmpty>
	  </td>
