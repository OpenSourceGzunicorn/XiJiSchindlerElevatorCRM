...
<html:hidden name="entrustContractMasterBean" property="billNo"/>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
    ...
    <tr>
      <td class="wordtd_a"><bean:message key="maintContract.contractPeriod"/>（月）:</td>
      <td >
    ...
    <tr>
     ...
     <tr> 
      ...
      <td nowrap="nowrap" class="wordtd_a">退保录入日期:</td>
      <td ><bean:write name="entrustContractMasterBean" property="tbOperDate"/></td>    
    </tr> <tr> 
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
    <tr>
      ...
      <td width="20%">
        <bean:write name="entrustContractMasterBean" property="contractTotal"/>
      </td>          
      <td nowrap="nowrap" class="wordtd_a">其它费用:</td>
      <td width="20%">
        <bean:write name="entrustContractMasterBean" property="otherFee"/>
      </td>    
      <td nowrap="nowrap" class="wordtd_a"></td>
      <td width="20%"></td>      
    </tr>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
  	...
  	<tr>
  		...
  		<td colspan="5"><bean:write name="entrustContractMasterBean" property="auditRem"/></td>
  	</tr>
  </table>
