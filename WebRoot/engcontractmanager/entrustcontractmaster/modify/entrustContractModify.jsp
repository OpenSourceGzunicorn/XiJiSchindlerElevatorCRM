...
<body>
  <html:errors/>
  <html:form action="/entrustContractModifyAction.do?method=toAuditRecord">
...
<html:hidden name="entrustContractMasterBean" property="billNo"/>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
    ...
    <tr>
      ...
      <td >
        <html:text name="entrustContractMasterBean" property="contractSdate" styleId="contractSdate" size="12" styleClass="Wdate" onfocus="pickStartDay('contractEdate')" /><font color="red">*</font>  
    </td>
      <td nowrap="nowrap" class="wordtd_a"><bean:message key="maintContract.contractEdate"/>:</td>
      <td >
      	<html:text name="entrustContractMasterBean" property="contractEdate" styleId="contractEdate" size="12" styleClass="Wdate" onfocus="pickEndDay('contractSdate')" /><font color="red">*</font>   
    </td>         
    </tr>        
    <tr>
    ...
    <tr> 
      ...
      <td n>
        <bean:write name="entrustContractMasterBean" property="endDate"/>
      </td>
        ...
        <logic:present name="entrustContractDetailList">
          <logic:iterate id="e" name="entrustContractDetailList" >
            <tr>
              ...
              <td align="center">
             	<input type="hidden" name="rowid" value="${e.rowid }"/>	
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
    <tr>
      ...
      <td width="20%">
          <html:text name="entrustContractMasterBean" property="contractTotal" styleClass="default_input" styleId="contractTotal" onchange="checkthisvalue(this);"/><font color="red">*</font>
      </td>          
      <td nowrap="nowrap" class="wordtd_a">其它费用:</td>
      <td width="20%">
          <html:text name="entrustContractMasterBean" property="otherFee" styleClass="default_input" styleId="otherFee" onchange="checkthisvalue(this);"/>
      </td>    
      <td nowrap="nowrap" class="wordtd_a">&nbsp;</td>
      <td width="20%">&nbsp;</td>      
    </tr>
    <tr>
      ...
      <td colspan="5">
      	<html:textarea name="entrustContractMasterBean" property="paymentMethod" rows="3" cols="100" styleClass="default_textarea"/>
      </td> 
    </tr>
    <tr>
