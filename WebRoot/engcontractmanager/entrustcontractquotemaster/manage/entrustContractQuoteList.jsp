...
<html:hidden property="property(genReport)" styleId="genReport" />
  ...
  <br>
  <table:table id="guiEntrustContractQuote" name="entrustContractQuoteList">
    <logic:iterate id="element" name="entrustContractQuoteList">
      ...
      <table:define id="c_billNo">
        <a href="<html:rewrite page='/entrustContractQuoteMasterAction.do'/>?method=toDisplayRecord&id=<bean:write name="element"  property="billNo"/>&returnMethod=toSearchRecord">
