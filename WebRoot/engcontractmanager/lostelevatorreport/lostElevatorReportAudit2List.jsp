...
<html:hidden property="property(genReport)" styleId="genReport" />
  ...
  <br>
  <table:table id="guiLostElevatorReportAudit" name="lostElevatorReportAudit2List">
    <logic:iterate id="element" name="lostElevatorReportAudit2List">
      ...
      <table:define id="c_jnlno">
        <a href="<html:rewrite page='/lostElevatorReportAudit2Action.do'/>?method=toDisplayRecord&id=<bean:write name="element"  property="jnlno"/>">
      ...
      <table:define id="c_auditStatus">
        <logic:equal name="element" property="auditStatus2" value="Y">已审核</logic:equal>
        <logic:notEqual name="element" property="auditStatus2" value="Y">未审核</logic:notEqual>
      </table:define>
      <table:tr />
    </logic:iterate>
  </table:table>
