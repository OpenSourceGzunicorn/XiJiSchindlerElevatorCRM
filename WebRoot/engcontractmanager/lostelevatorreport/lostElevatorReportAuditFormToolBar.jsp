...
function CreateToolBar(){
  ...
  <logic:notPresent name="workisdisplay">
	  ...
	  <%-- 是否有可写的权限--%>
	  <logic:equal name="<%=SysConfig.TOOLBAR_RIGHT%>" property="nlostelevatorreportaudit" value="Y">
	  	<logic:notEqual name="lostElevatorReportBean" property="auditStatus" value="Y">
...
function returnMethod(){
	window.location = '<html:rewrite page="/lostElevatorReportAuditSearchAction.do"/>?method=toSearchRecord';
}

//审核
function auditing(value){
	var submitType=document.lostElevatorReportAuditForm.submitType.value;
	var auditStatus=document.lostElevatorReportAuditForm.auditStatus.value;
	if(submitType!="Y"){
		alert("此记录没有提交不能审核！");
		return;
	}
	...
	document.lostElevatorReportAuditForm.auditStatus.value=value;
