...
<html:hidden property="property(genReport)" styleId="genReport" />
  ...
  <br>
  <table:table id="guiLostElevatorReportAudit" name="lostElevatorReportAuditList">
    <logic:iterate id="element" name="lostElevatorReportAuditList">
      ...
      <table:define id="c_jnlno">
        <a href="<html:rewrite page='/lostElevatorReportAuditAction.do'/>?method=toDisplayRecord&id=<bean:write name="element"  property="jnlno"/>">
