...
function returnMethod(){
  window.location = '<html:rewrite page="/lostElevatorReportSearchAction.do"/>?method=toSearchRecord';
}
    ...
    if(l)
    {
      for(i=0;i<l;i++)
      {
        if(document.serveTableForm.ids[i].checked == true)
        {
          ...
          window.location = '<html:rewrite page="/lostElevatorReportAction.do"/>?billNo='+billNo+'&method=toPrepareAddRecord';
          return;       
        }
      }
      if(l >0)
