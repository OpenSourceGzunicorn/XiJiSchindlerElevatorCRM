...
<a href="" id="avf" target="_blank"></a>
  ...
  <br>
  <table:table id="guiMaintContractDelayAudit" name="maintContractDelayAuditList">
    <logic:iterate id="element" name="maintContractDelayAuditList">
      ...
      <table:define id="c_jnlno">
        <a href="<html:rewrite page='/maintContractDelayAuditAction.do'/>?method=toDisplayRecord&id=${element.jnlno}">
