...
//新建
function addMethod(){
	window.location = '<html:rewrite page="/maintContractDelaySearchAction.do"/>?method=toSearchNext';
}
...
function toDoMethod(index,method,params,alertMsg){
	if(index >= 0){	
		window.location = '<html:rewrite page="/maintContractDelayAction.do"/>?id='+getVal('ids',index)+'&method='+method+params;
