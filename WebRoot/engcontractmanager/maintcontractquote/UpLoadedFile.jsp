	...
	<logic:present name="updatefileList">
		...
		<logic:notEmpty name="updatefileList">
			<logic:iterate id="ele"  name="updatefileList">
				...
				<td align="center">
					<input type="button" name="display" value="下 载"  class="default_input"  onclick="downloadFile('${ele.filesid}')">
					&nbsp;
					<input type="button" name="del" value="删 除"  class="default_input" onclick="deleteFile('${ele.filesid}','${ele.oldfilename}',this)">
				</td>
				</tr>
			</logic:iterate>
		</logic:notEmpty>
