...
<a href="" id="avf" target="_blank"></a>
  <table>
    ...
    <tr>               
      ...
      <td>
        <html:select property="property(isscht)">
          <html:option value="">全部</html:option>
  ...
  <table:table id="guiMaintContractQuote" name="maintContractQuoteAuditList">
    <logic:iterate id="element" name="maintContractQuoteAuditList">
      ...
      <table:define id="c_billNo">
        <a href="<html:rewrite page='/maintContractQuoteAuditAction.do'/>?method=toDisplayRecord&id=<bean:write name="element"  property="billNo"/>">
