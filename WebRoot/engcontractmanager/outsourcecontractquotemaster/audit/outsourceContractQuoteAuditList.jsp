...
<a href="" id="avf" target="_blank"></a>
  ...
  <table:table id="guiOutsourceContractQuote" name="outsourceContractQuoteAuditList">
    <logic:iterate id="element" name="outsourceContractQuoteAuditList">
      ...
      <table:define id="c_billNo">
        <a href="<html:rewrite page='/outsourceContractQuoteAuditAction.do'/>?method=toDisplayRecord&id=<bean:write name="element"  property="billNo"/>">
