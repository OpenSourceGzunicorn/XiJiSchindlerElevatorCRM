...
<html:hidden property="property(genReport)" styleId="genReport" />
  ...
  <br>
  <table:table id="guiOutsourceContractQuote" name="outsourceContractQuoteList">
    <logic:iterate id="element" name="outsourceContractQuoteList">
      ...
      <table:define id="c_billNo">
        <a href="<html:rewrite page='/outsourceContractQuoteMasterAction.do'/>?method=toDisplayRecord&id=<bean:write name="element"  property="billNo"/>">
