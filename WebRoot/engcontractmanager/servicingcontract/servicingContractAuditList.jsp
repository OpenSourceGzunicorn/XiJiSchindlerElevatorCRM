...
<html:hidden property="property(genReport)" styleId="genReport" />
  ...
  <br>
  <table:table id="guiServicingContract" name="wgchangeContractAuList">
    <logic:iterate id="element" name="wgchangeContractAuList">
      ...
      <table:define id="c_billNo">       
       <a href="<html:rewrite page="/wgchangeContractAuditAction.do"/>?method=toDisplayRecord&id=${element.wgBillno }"><bean:write name="element" property="wgBillno" /></a>       
      </table:define>
