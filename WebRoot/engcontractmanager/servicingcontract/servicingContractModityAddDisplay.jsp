...
<html:errors/> 
<html:form action="/wgchangeContractAction.do" enctype="multipart/form-data">
<input type="hidden" name="typejsp" id="typejsp" value="${ typejsp}"/>
<a href="" id="avf" target="_blank"></a>
<%-- <logic:equal name="typejsp" value="add"> 2016-05-04
...
<div id="divshoww" style="display:inline;">
	<%@ include file="newservicingContractAdd.jsp" %>
</div>
 </logic:equal> 
 <logic:equal name="typejsp" value="mondity">
<div id="divshoww" style="display:inline;">
	<%@ include file="newservicingContractModity.jsp" %>
</div>
 </logic:equal>
