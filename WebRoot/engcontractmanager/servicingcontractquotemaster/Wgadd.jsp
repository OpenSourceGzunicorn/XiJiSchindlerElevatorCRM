...
<script language="javascript" src="<html:rewrite forward="jq.js"/>"></script>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
      ...
      <tr>
        ...
        <td nowrap>
          ...
          <input type="text" name="companyName" id="companyName" value="${companyName}" readonly="true"  styleClass="Wdate"/>
        ...
        <td><input type="text" name="companyContacts" id="contacts" value="${companyContacts}" readonly="true" class="default_input_noborder"/></td>
        <td class="wordtd">甲方联系电话:</td>
        <td><input type="text" name="companyPhone" id="contactPhone" value="${companyPhone}" readonly="true" class="default_input_noborder"/></td>           
      </tr> 
      <tr>
      ...
      <td colspan="5"><textarea name="otherCustomer" rows="2" cols="80"></textarea></td> 
      </tr>       
    </table>
    <br>
    <div class="tb" style="padding-top: 2;padding-bottom: 2;border-bottom: 0">&nbsp;<input type="button" value=" + " onclick="addElevators('table_22')">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb" id="table_22">
      <thead  >
        <tr id="tb_head" class="tb_head" >
          <td class="wordtd_header" width="3%"><input type="checkbox" id="checkAll" onclick="checkTableAll('table_22',this)"/></td>
        ...
        <logic:present name="maintContractQuoteDetailList">
          <logic:iterate id="element" name="maintContractQuoteDetailList" >
            <tr>
              ...
              <td align="center"><textarea name="contents" id="contents" rows="2" cols="60"></textarea></td>
              </tr>
          </logic:iterate>
        </logic:present>
      </tbody>    
    ...
    <logic:present name="PulldownList">
   <logic:iterate name="PulldownList" id="element">
   <tr>
   <td align="center" width="10%">${element.orderby }</td>
   <td align="center" width="70%">${element.pullname }<input type="hidden" name="pullid" id="pullid" value="${element.id.pullid }"/></td>
   <td align="center" width="10%"><input type="text"  name="price" id="price" style="text-align:right" value="0"onpropertychange="checkthisvalue(this);sumValuesByName2('price','price2','standardQuoteTotal');"/></td>
   <td align="center" width="10%"><input type="text"  name="finalPrice" id="finalPrice" style="text-align:right" value="0" onpropertychange="checkthisvalue(this);sumValuesByName2('finalPrice','finalPrice2','finallyQuoteTotal');"/></td>  
   </tr>
   </logic:iterate>
    </logic:present>
    </table>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
      <tr>
        ...
        <td width="20%"><html:text name="ServicingContractQuoteMaster" property="businessCosts" onchange="checkthisvalue(this);" /></td>
      </tr>
    </table>
    <br>
