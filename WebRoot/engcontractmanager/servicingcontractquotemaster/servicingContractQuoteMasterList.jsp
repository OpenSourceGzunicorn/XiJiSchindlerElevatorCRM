...
<html:hidden property="property(genReport)" styleId="genReport" />
  ...
  <br>
  <table:table id="guiContractQuoteMaster" name="wgchangeContractQuoteList">
    <logic:iterate id="element" name="wgchangeContractQuoteList">
      ...
      <table:define id="c_billNo">
       <a href="<html:rewrite page='/wgchangeAction.do'/>?method=toDisplayRecord&id=<bean:write name="element"  property="billNo"/>"/>
