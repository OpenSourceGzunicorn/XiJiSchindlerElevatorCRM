...
<br>
<html:errors/>
<html:form action="/advisoryComplaintsManageAction.do?method=toDispatchRecord">
<logic:present name="advisoryComplaintsManageBean">
<html:hidden property="isreturn"/>
<html:hidden name="advisoryComplaintsManageBean" property="dispatchType"/>
<html:hidden name="advisoryComplaintsManageBean" property="submitType"/>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
      <tr>
			...
			<td width="30%"><bean:write name="advisoryComplaintsManageBean" property="processSingleNo"/>
	...
	<tr>
			...
			<td><%-- <bean:write name="advisoryComplaintsManageBean" property="processPer"/> --%>
				<html:select name="advisoryComplaintsManageBean" property="processPer">
					<html:option value="">--请选择--</html:option>
					<html:options collection="processList" property="userid" labelProperty="username"/>
				</html:select>
				<font color="red">*</font>
			</td>
	</tr>
