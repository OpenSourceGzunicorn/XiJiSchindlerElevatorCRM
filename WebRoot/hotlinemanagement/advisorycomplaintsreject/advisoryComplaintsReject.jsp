...
<br>
<html:errors/>
<html:form action="/advisoryComplaintsManageAction.do?method=toRejectRecord">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
      <tr>
			<td class="wordtd" width="20%">驳回路径:</td>
			<td width="30%">
				<select id="returnpath" name="returnpath">
					<option value="">请选择</option>
					<option value="1">驳回到分析总结</option>
					<option value="2">驳回到处理</option>
				</select>
				<font color="red">*</font>
			</td>
