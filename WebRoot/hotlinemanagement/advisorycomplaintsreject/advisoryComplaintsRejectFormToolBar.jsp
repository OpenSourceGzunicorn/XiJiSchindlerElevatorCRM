...
function CreateToolBar(){
  ...
  <logic:equal name="<%=SysConfig.TOOLBAR_RIGHT%>" property="nadvisorycomplaintsreject" value="Y"> 
    AddToolBarItemEx("SaveBtn","../../common/images/toolbar/delete.gif","","",'驳回',"65","1","saveMethod()");
...
function returnMethod(){
  window.location = '<html:rewrite page="/advisoryComplaintsManageSearchAction.do"/>?method=toSearchRecordReject';
}
...
function saveMethod(){
  ...
  document.advisoryComplaintsManageForm.submit();
	//window.location = '<html:rewrite page="/advisoryComplaintsManageAction.do"/>?method=toRejectRecord';
}
