...
<tr> <td class="wordtd_a">项目名称及楼栋号:</td>
 ...
 <tr>   
    <td class="wordtd_a">驳回意见:</td>
    <td  colspan="5">
    <logic:equal name="typejsp" value="sh">
    	<textarea rows="3" cols="60" name="bhAuditRem" id="bhAuditRem" >${CalloutMasterList.bhAuditRem }</textarea>
    </logic:equal>
    <logic:notEqual name="typejsp" value="sh">
    	${CalloutMasterList.bhAuditRem }
    </logic:notEqual>
    </td>
</tr>

</table>
<%@ include file="calloutMasterDisplay2.jsp" %>
<table width="99%" class="tb"  height="25">
		<tr>
