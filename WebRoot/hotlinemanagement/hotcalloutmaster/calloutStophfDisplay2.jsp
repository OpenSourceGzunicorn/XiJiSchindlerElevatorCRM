...
<tr>
	...
	<td width="23%" colspan="5">
		<html:textarea name="CalloutMasterList" property="stophfRem" styleId="stophfRem" rows="3" cols="90"> ${CalloutMasterList.stophfRem}</html:textarea>
	</td>
</tr>
<tr>
...
<tr>
    ...
    <td  width="23%">
    <input type="radio" name="isSendSms" id="isSendSms" value="Y" >是
    <input type="radio" name="isSendSms" id="isSendSms" value="N" checked>否
    </td>
</tr>
<tr>
...
<tr>
 ...
 <td colspan="5">${CalloutMasterList.auditRem }</textarea>
</tr>
