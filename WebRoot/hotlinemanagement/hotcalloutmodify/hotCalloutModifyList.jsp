...
<html:hidden property="property(genReport)" styleId="genReport" />
  ...
  <br>
  <table:table id="guiHotCalloutModify" name="hotCalloutModify">
    <logic:iterate id="element" name="hotCalloutModify">
      <table:define id="c_cb">
        ...
        <%-- <input type="hidden"  name="handleStatus" id="handleStatus" value="${element.handleStatus }">   --%>     
      </table:define>
      <table:define id="c_calloutMasterNo">
       ${element.calloutMasterNo }    
      </table:define>
