...
<br/>
 ...
 <td class="wordtd">客户签名:</td>
    ...
    <logic:notEmpty name="elevatorTransferCaseRegisterBean" property="customerSignature">
    	<img src="<%=basePath%>/elevatorTransferCaseRegisterManageAction.do?method=toDownloadFileRecord1&customerSignature=${elevatorTransferCaseRegisterBean.customerSignature}"
	...
	<logic:notEmpty name="elevatorTransferCaseRegisterBean" property="customerImage">	
		<img src="<%=basePath%>/elevatorTransferCaseRegisterManageAction.do?method=toDownloadFileRecord1&customerImage=${elevatorTransferCaseRegisterBean.customerImage}"
