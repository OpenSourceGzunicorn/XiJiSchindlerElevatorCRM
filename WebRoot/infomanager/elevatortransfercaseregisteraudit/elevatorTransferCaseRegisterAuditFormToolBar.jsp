...
function returnMethod(){
  window.location = '<html:rewrite page="/elevatorTransferCaseRegisterAuditSearchAction.do"/>';
}

//下载附件
function downloadFile(name,oldName,filePath){
	var uri = '<html:rewrite page="/elevatorTransferCaseRegisterAuditAction.do"/>?method=toDownloadFileDispose';
