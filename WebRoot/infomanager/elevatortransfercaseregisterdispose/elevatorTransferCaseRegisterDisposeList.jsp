...
<html:form action="/ServeTable.do">
	...
	<br>
	<table:table id="guiElevatorTransferCaseRegisterDA" name="elevatorTransferCaseRegisterDisposeList">
    <logic:iterate id="element" name="elevatorTransferCaseRegisterDisposeList">
