...
<br>
<html:errors/>
<html:form action="/elevatorTransferCaseRegisterAction.do?method=toDisposeRejectRecord" enctype="multipart/form-data">
...
<html:hidden property="hecirs" />
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
   ...
   <td nowrap="nowrap" class="wordtd">厂检人员名称：</td>
   	<td>
   		<html:text name="elevatorTransferCaseRegisterBean" property="staffName" styleClass="default_input_noborder" />
   	</td>
  ...
  <tr>
   <td nowrap="nowrap" class="wordtd">录入人：</td>
	...
	<tr>
		...
		<td>
		<%-- bean:write name="bhDate"/>--%>
			<html:text property="bhDate" size="23" styleClass="Wdate" value="${bhDate }" onfocus="WdatePicker({isShowClear:true,readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
		</td>
		<td nowrap="nowrap" class="wordtd">驳回分类：</td>
		<td>
		<html:select name="elevatorTransferCaseRegisterBean" property="bhType">
		...
		<td>
		<html:textarea name="elevatorTransferCaseRegisterBean" property="bhRem" styleClass="default_textarea" cols="30" rows="2"></html:textarea><font color="red">*</font></td>
