...
<html:form action="/ServeTable.do">
	<table>
		...
		<tr>
			...
			<td>
				<bean:message key="qualitycheckmanagement.submitType"/>
				:
			</td>
			<td>
			...
			<td>
				<html:select property="property(processStatus)">
				  <logic:equal name="showstate" value="Y">
			          <html:option value=""><bean:message key="qualitycheckmanagement.all"/></html:option>
				      <html:option value="0">未登记</html:option>
	...
	<br>
	<table:table id="guiQualityCheckManagement" name="qualityCheckManagementList">
		<logic:iterate id="element" name="qualityCheckManagementList">
			<table:define id="c_cb">
			 ...
			 <table:define id="c_billno">
				 <a href="<html:rewrite page='/qualityCheckManagementAction.do'/>?method=toDisplayRecord&id=<bean:write name="element"  property="billno"/>"> 
