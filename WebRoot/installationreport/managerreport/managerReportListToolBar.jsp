...
function returnMethod(){
  window.location = '<html:rewrite page="/managerReportAction.do"/>?method=toSearchRecord';
}
//导出Excel
function excelMethod(){
	managerReportForm.genReport.value="Y";
	managerReportForm.target = "_blank";
	document.managerReportForm.submit();
}
