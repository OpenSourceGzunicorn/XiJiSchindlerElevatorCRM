...
function returnMethod(){
  window.location = '<html:rewrite page="/runReportAction.do"/>?method=toSearchRecord';
}
//关闭
...
function excelMethod(){
	runReportForm.genReport.value="Y";
	runReportForm.target = "_blank";
