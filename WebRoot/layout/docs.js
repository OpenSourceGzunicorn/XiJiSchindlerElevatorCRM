...
MainPanel = function(){
    ...
    MainPanel.superclass.constructor.call(this, {
        ...
        items: {
            id:'welcome-panel',
            title: '数据分析(2009-02-06)',
           // autoLoad: {url: 'date.html', callback: this.initSearch, scope: this},
			html:'<iframe frameborder="0" width="100%" height="100%" src="date.html"></iframe>',
            iconCls:'icon-docs',
            autoScroll: true
        }
    });
...
var mp;
function loadClass1(o,id,href){
		cls=id.replace("docs-","");		
		var oo=mp;
		var html=document.all["frm1"].contentWindow.document.body.innerHTML;
            var p = oo.add(new DocPanel({
                id: id,
                cclass : cls,
				html:html,
...
Ext.extend(MainPanel, Ext.TabPanel, {
    ...
    loadClass : function(href, cls, member){
        ...
        if(tab){
			...
			setTimeout('loadClass1(this,"'+id+'");',500);
