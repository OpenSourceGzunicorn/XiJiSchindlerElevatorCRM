...
<html:errors/>
 <logic:present name="maintContractMasterBean">
   <table id="contractInfoTable" width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
    ...
    <tr>
      ...
      <td nowrap="nowrap" width="20%">自保</td>
    ...
    <tr>
      <td class="wordtd_a">定制人:</td>
      <td>
        ${operidkk}
      </td> 
      <td class="wordtd_a">定制日期:</td>
      <td>
        ${ operdatekk}
      </td>
 ...
 <br/>
  ...
  <table id="contractInfoTable" width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
    ...
    <td class="wordtd_a" style="text-align: center;" nowrap="nowrap">维保开始时间</td>
    <td class="wordtd_a" style="text-align: center;" nowrap="nowrap">维保计划开始时间</td>
    <td class="wordtd_a" style="text-align: center;" nowrap="nowrap">维保结束时间</td>
    <td class="wordtd_a" style="text-align: center;">下达维保站</td>
    <td class="wordtd_a" style="text-align: center;">维保工</td>
    <td class="wordtd_a" style="text-align: center;" nowrap="nowrap">保养逻辑</td>
    </tr>
    ...
    <td nowrap="nowrap" style="text-align: center;">
		<logic:equal name="element" property="r3" value="1">逻辑一</logic:equal>
		<logic:equal name="element" property="r3" value="2">逻辑二</logic:equal>
		<logic:equal name="element" property="r3" value="3">逻辑三</logic:equal>
		<logic:equal name="element" property="r3" value="4">逻辑四</logic:equal>
		<logic:equal name="element" property="r3" value="5">逻辑五</logic:equal>
	</td> 
    </tr>
    </logic:iterate>
    </table>
 ...
 <tr>
      ...
      <td  nowrap="nowrap" class="wordtd_a" >审核日期:</td>
