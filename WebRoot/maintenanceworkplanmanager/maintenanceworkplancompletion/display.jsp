...
<logic:present name="maintenanceWorkPlanDetailBean">
  ...
  <br>
	  ...
	  <div style="border:solid #999999 1px;border-bottom:none;padding-top: 4;padding-bottom: 4;background:#ffffff;">        
	   ...
	   <td><bean:write name="maintenanceWorkPlanDetailBean" property="usedDuration"/></td>
	   <td class="wordtd">所用时长评分:</td>
		<td><bean:write name="maintenanceWorkPlanDetailBean" property="dateScore"/></td>
	   </tr>
	   <tr>
	   <td class="wordtd">距离评分:</td>
	   <td><bean:write name="maintenanceWorkPlanDetailBean" property="distanceScore"/></td>
	   <td class="wordtd">保养得分:</td>
		<td><bean:write name="maintenanceWorkPlanDetailBean" property="maintScore"/></td>
	   </tr>
	   <tr>
  ...
  <table  width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
  <tr>
   <td nowrap="nowrap" class="wordtd">备注:</td>
   <td  colspan="3"><bean:write name="maintenanceWorkPlanDetailBean" property="rem"/></td>
   </tr>
   <tr>
   <td nowrap="nowrap" class="wordtd">审核人:</td>
   <td width="30%"><bean:write name="maintenanceWorkPlanDetailBean" property="byAuditOperid"/> </td>
   <td nowrap="nowrap" class="wordtd">审核日期：</td>
   <td  width="30%"><bean:write name="maintenanceWorkPlanDetailBean" property="byAuditDate"/></td>
   </tr>
    </table>
  <br>
  <table  width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
   ...
   <td  colspan="3"><bean:write name="maintenanceWorkPlanDetailBean" property="fittingsReplace"/></td>
   </tr>
   <tr>
   <td nowrap="nowrap" class="wordtd">是否有单据:</td>
   <td  width="30%" colspan="3"> ${maintenanceWorkPlanDetailBean.isInvoice=='Y'?'是':'否'}</td>
   </tr>
   <tr>
