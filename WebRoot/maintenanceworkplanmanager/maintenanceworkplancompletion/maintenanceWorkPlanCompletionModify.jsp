...
<html:form action="/maintenanceWorkPlanCompletionAction.do?method=toUpdateRecord">
<html:errors/>
...
<logic:present name="maintenanceWorkPlanDetailBean">
  ...
  <div style="border:solid #999999 1px;border-bottom:none;padding-top: 4;padding-bottom: 4;background:#ffffff;">        
   ...
   <td>
    	...
    	<input type="hidden" name="usedDuration" value="<bean:write name="maintenanceWorkPlanDetailBean" property="usedDuration"/>"/>
   </td>
   <td class="wordtd">所用时长评分:</td>
	<td>
		<bean:write name="maintenanceWorkPlanDetailBean" property="dateScore"/>
		<input type="hidden" name="dateScore" value="<bean:write name="maintenanceWorkPlanDetailBean" property="dateScore"/>"/>
	</td>
   </tr>
   <tr>
   ...
   <td>
   		...
   		<input type="hidden" name="distanceScore" value="<bean:write name="maintenanceWorkPlanDetailBean" property="distanceScore"/>"/>
   	</td>
   <td class="wordtd">保养得分:</td>
	<td>
		<bean:write name="maintenanceWorkPlanDetailBean" property="maintScore"/>
		<input type="hidden" name="maintScore" value="<bean:write name="maintenanceWorkPlanDetailBean" property="maintScore"/>"/>
	</td>
  ...
  <tr>
   ...
   <td nowrap="nowrap" colspan="3" width="75%">
  	 <html:textarea name="maintenanceWorkPlanDetailBean" rows="3" cols="120" property="rem"></html:textarea>
   </td>
   </tr>
   <tr>
