...
<html:hidden property="property(genReport)" styleId="genReport" />
  <table>
    <tr>
      ...
      <td>
		...
		<td >
		<html:text property="property(sdate1)" styleClass="Wdate" size="12" onfocus="WdatePicker({isShowClear:true})"></html:text>
		- 
		<html:text property="property(edate1)" styleClass="Wdate" size="12" onfocus="WdatePicker({isShowClear:true})"></html:text>
		</td>           
    </tr>
    <tr>  
     <td> 
  ...
  <br>
  <table:table id="guiMaintenanceWorkPlanCustomize" name="maintenanceWorkPlanCustomizeList">
    <logic:iterate id="element" name="maintenanceWorkPlanCustomizeList">
      ...
      <table:define id="c_billNo">
        <a href="<html:rewrite page='/maintenanceWorkPlanCustomizeAction.do'/>?method=toDisplayRecord&id=<bean:write name="element"  property="billNo"/>">
      ...
      <table:define id="c_submitType">
        ...
        <logic:match name="element" property="r1" value="R">驳回</logic:match>       
        </logic:notEmpty>
        <html:hidden name="element" property="r1" />
      </table:define>      
      <table:define id="c_auditStatus">
         <input type="hidden" name="checkflag" value='<bean:write name="element" property="auditStatus"/>'>
      ...
      <table:define id="c_customizeRem">
        <bean:write name="element" property="customizeRem" />
      </table:define>
      <table:tr />
    </logic:iterate>
    </table:table>
