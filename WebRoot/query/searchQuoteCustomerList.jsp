...
<html:hidden property="property(quote)"/>
  <table>
    <tr>
      <td>
  ...
  <br>
  <table:table id="guiSearchCustomer" name="quoteCustomerList">
    <logic:iterate id="element" name="quoteCustomerList">
      <table:define id="c_cb">
        ...
        <html:hidden name="element" property="qualiLevelWb" styleId="qualiLevelWb"/>
        <html:hidden name="element" property="qualiLevelWg" styleId="qualiLevelWg"/>     
      </table:define>
