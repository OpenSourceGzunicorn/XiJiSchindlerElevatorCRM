...
function searchMethod(){
	 ...
	 document.calloutMasterIsStopForm.genReport.value="";
	 document.calloutMasterIsStopForm.target = "_blank";
	 document.calloutMasterIsStopForm.submit();
...
function excelMethod(){
	...
	document.calloutMasterIsStopForm.genReport.value="Y";
	document.calloutMasterIsStopForm.target = "_blank";
	document.calloutMasterIsStopForm.submit();
}
...
function Evenmore(obj,listname){	
	...
	if(comid!="" && comid!="%"){
		 ...
		 var url='<html:rewrite page="/calloutMasterIsStopReportAction.do"/>?method=toStorageIDList&comid='+comid;//跳转路径
