...
function searchMethod(){
	 ...
	 document.calloutMasterIsTrapForm.genReport.value="";
	 document.calloutMasterIsTrapForm.target = "_blank";
	 document.calloutMasterIsTrapForm.submit();
...
function excelMethod(){
	...
	document.calloutMasterIsTrapForm.genReport.value="Y";
	document.calloutMasterIsTrapForm.target = "_blank";
	document.calloutMasterIsTrapForm.submit();
}
...
function Evenmore(obj,listname){	
	...
	if(comid!="" && comid!="%"){
		 ...
		 var url='<html:rewrite page="/calloutMasterIsTrapReportAction.do"/>?method=toStorageIDList&comid='+comid;//跳转路径
