...
function searchMethod(){
	 ...
	 document.companyPaymentReportForm.genReport.value="";
	 document.companyPaymentReportForm.target = "_blank";
	 document.companyPaymentReportForm.submit();
...
function excelMethod(){
	...
	document.companyPaymentReportForm.genReport.value="Y";
	document.companyPaymentReportForm.target = "_blank";
	document.companyPaymentReportForm.submit();
}
...
function Evenmore(obj,listname){	
	...
	if(comid!="" && comid!="%"){
		 ...
		 var url='<html:rewrite page="/flatBillContractReportAction.do"/>?method=toStorageIDList&comid='+comid;//跳转路径
