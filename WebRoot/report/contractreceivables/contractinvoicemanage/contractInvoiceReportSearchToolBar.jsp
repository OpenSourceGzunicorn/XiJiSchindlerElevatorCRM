...
function searchMethod(){
	 ...
	 document.contractinvoiceReportForm.genReport.value="";
	 document.contractinvoiceReportForm.target = "_blank";
	 document.contractinvoiceReportForm.submit();
...
function excelMethod(){
	...
	document.contractinvoiceReportForm.genReport.value="Y";
	document.contractinvoiceReportForm.target = "_blank";
	document.contractinvoiceReportForm.submit();
}
...
function Evenmore(obj,listname){	
	...
	if(comid!="" && comid!="%"){
		 ...
		 var url='<html:rewrite page="/contractInvoiceReportAction.do"/>?method=toStorageIDList&comid='+comid;//跳转路径
