...
function searchMethod(){
	 ...
	 document.contractParagraphReportForm.genReport.value="";
	 document.contractParagraphReportForm.target = "_blank";
	 document.contractParagraphReportForm.submit();
...
function excelMethod(){
	...
	document.contractParagraphReportForm.genReport.value="Y";
	document.contractParagraphReportForm.target = "_blank";
	document.contractParagraphReportForm.submit();
}
...
function Evenmore(obj,listname){	
	...
	if(comid!="" && comid!="%"){
		 ...
		 var url='<html:rewrite page="/contractParagraphReportAction.do"/>?method=toStorageIDList&comid='+comid;//跳转路径
