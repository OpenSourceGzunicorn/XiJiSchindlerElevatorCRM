...
function searchMethod(){
	 ...
	 document.contractQianKuanReportForm.genReport.value="";
	 document.contractQianKuanReportForm.target = "_blank";
	 document.contractQianKuanReportForm.submit();
...
function excelMethod(){
	...
	document.contractQianKuanReportForm.genReport.value="Y";
	document.contractQianKuanReportForm.target = "_blank";
	document.contractQianKuanReportForm.submit();
}
...
function Evenmore(obj,listname){	
	...
	if(comid!="" && comid!="%"){
		 ...
		 var url='<html:rewrite page="/contractQianKuanReportAction.do"/>?method=toStorageIDList&comid='+comid;//跳转路径
