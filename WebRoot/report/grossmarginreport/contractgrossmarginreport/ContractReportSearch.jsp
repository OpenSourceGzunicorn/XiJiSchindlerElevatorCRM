...
<br>
<html:form action="/contractGrossMarginReportAction.do?method=toSearchResults">
<html:hidden property="genReport" styleId="genReport" />
 <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
    ...
    <tr>
    	...
    	<td width="80%" class="inputtd">
    		<html:text property="contractno" styleClass="default_input" size="35" />
    	</td>
    </tr>
    <tr>
    ...
    <tr>
	    <td width="20%" class="wordtd">毛利统计日期:</td>
	    <td width="80%" class="inputtd">
