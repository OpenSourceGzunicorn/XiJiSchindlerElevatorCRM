...
function searchMethod(){
	 ...
	 document.contractGrossMarginReportForm.genReport.value="";
	 document.contractGrossMarginReportForm.target = "_blank";
	 document.contractGrossMarginReportForm.submit();
...
function excelMethod(){
	...
	document.contractGrossMarginReportForm.genReport.value="Y";
	document.contractGrossMarginReportForm.target = "_blank";
	document.contractGrossMarginReportForm.submit();
}
...
function Evenmore(obj,listname){	
	...
	if(comid!="" && comid!="%"){
		 ...
		 var url='<html:rewrite page="/contractGrossMarginReportAction.do"/>?method=toStorageIDList&comid='+comid;//跳转路径
