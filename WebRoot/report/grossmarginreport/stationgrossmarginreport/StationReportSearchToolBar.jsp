...
function searchMethod(){
	 ...
	 document.stationGrossMarginReportForm.genReport.value="";
	 document.stationGrossMarginReportForm.target = "_blank";
	 document.stationGrossMarginReportForm.submit();
...
function excelMethod(){
	...
	document.stationGrossMarginReportForm.genReport.value="Y";
	document.stationGrossMarginReportForm.target = "_blank";
	document.stationGrossMarginReportForm.submit();
}
...
function Evenmore(obj,listname){	
	...
	if(comid!="" && comid!="%"){
		 ...
		 var url='<html:rewrite page="/stationGrossMarginReportAction.do"/>?method=toStorageIDList&comid='+comid;//跳转路径
