...
function searchMethod(){
	 ...
	 document.bytlReportForm.genReport.value="";
	 document.bytlReportForm.target = "_blank";
	 document.bytlReportForm.submit();
...
function excelMethod(){
	...
	document.bytlReportForm.genReport.value="Y";
	document.bytlReportForm.target = "_blank";
	document.bytlReportForm.submit();
}
...
function Evenmore(obj,listname){	
	...
	if(comid!="" && comid!="%"){
		 ...
		 var url='<html:rewrite page="/bytlReportAction.do"/>?method=toStorageIDList&comid='+comid;//跳转路径
