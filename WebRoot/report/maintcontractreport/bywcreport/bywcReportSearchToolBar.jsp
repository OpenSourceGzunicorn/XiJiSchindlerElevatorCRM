...
function searchMethod(){
	 ...
	 document.bywcReportForm.genReport.value="";
	 document.bywcReportForm.target = "_blank";
	 document.bywcReportForm.submit();
...
function excelMethod(){
	...
	document.bywcReportForm.genReport.value="Y";
	document.bywcReportForm.target = "_blank";
	document.bywcReportForm.submit();
}
...
function Evenmore(obj,listname){	
	...
	if(comid!="" && comid!="%"){
		 ...
		 var url='<html:rewrite page="/bywcReportAction.do"/>?method=toStorageIDList&comid='+comid;//跳转路径
