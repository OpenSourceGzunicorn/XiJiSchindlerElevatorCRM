...
function searchMethod(){
	 ...
	 document.eleNumReportForm.genReport.value="";
	 document.eleNumReportForm.target = "_blank";
	 document.eleNumReportForm.submit();
...
function excelMethod(){
	...
	document.eleNumReportForm.genReport.value="Y";
	document.eleNumReportForm.target = "_blank";
	document.eleNumReportForm.submit();
}
...
function Evenmore(obj,listname){	
	...
	if(comid!="" && comid!="%"){
		 ...
		 var url='<html:rewrite page="/eleNumReportAction.do"/>?method=toStorageIDList&comid='+comid;//跳转路径
