...
<html:hidden property="genReport" styleId="genReport" />
 <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb">
    ...
    <tr>
    	<td width="20%" class="wordtd">丢梯原因:</td>
    	<td width="80%" class="inputtd">
    		<html:select property="causeanalysis" styleId="causeanalysis">
    			<html:option value="%">全部</html:option>
    			<html:option value="XQN">续签未成功</html:option>
		    	<html:options collection="causeAnalysisList" property="id.pullid" labelProperty="pullname"/>
    		</html:select>
    	</td>
    </tr>
    <tr>
	    <td width="20%" class="wordtd">办理退保日期:</td>
	    <td width="80%" class="inputtd">
    ...
    <tr>
	    <td width="20%" class="wordtd">退保审核通过日期:</td>
	    <td width="80%" class="inputtd">
