...
function searchMethod(){
	 ...
	 document.tbReportForm.genReport.value="";
	 document.tbReportForm.target = "_blank";
	 document.tbReportForm.submit();
...
function excelMethod(){
	...
	document.tbReportForm.genReport.value="Y";
	document.tbReportForm.target = "_blank";
	document.tbReportForm.submit();
}
...
function Evenmore(obj,listname){	
	...
	if(comid!="" && comid!="%"){
		 ...
		 var url='<html:rewrite page="/tbReportAction.do"/>?method=toStorageIDList&comid='+comid;//跳转路径
