...
function searchMethod(){
	 ...
	 document.wbjlReportForm.genReport.value="";
	 document.wbjlReportForm.target = "_blank";
	 document.wbjlReportForm.submit();
...
function excelMethod(){
	...
	document.wbjlReportForm.genReport.value="Y";
	document.wbjlReportForm.target = "_blank";
	document.wbjlReportForm.submit();
}
...
function Evenmore(obj,listname){	
	...
	if(comid!="" && comid!="%"){
		 ...
		 var url='<html:rewrite page="/wbjlReportAction.do"/>?method=toStorageIDList&comid='+comid;//跳转路径
