...
function searchMethod(){
	 ...
	 document.zbEleReportForm.genReport.value="";
	 document.zbEleReportForm.target = "_blank";
	 document.zbEleReportForm.submit();
...
function excelMethod(){
	...
	document.zbEleReportForm.genReport.value="Y";
	document.zbEleReportForm.target = "_blank";
	document.zbEleReportForm.submit();
}
...
function Evenmore(obj,listname){	
	...
	if(comid!="" && comid!="%"){
		 ...
		 var url='<html:rewrite page="/zbEleReportAction.do"/>?method=toStorageIDList&comid='+comid;//跳转路径
