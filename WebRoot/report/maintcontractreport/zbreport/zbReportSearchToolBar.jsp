...
function searchMethod(){
	 ...
	 document.zbReportForm.genReport.value="";
	 document.zbReportForm.target = "_blank";
	 document.zbReportForm.submit();
...
function excelMethod(){
	...
	document.zbReportForm.genReport.value="Y";
	document.zbReportForm.target = "_blank";
	document.zbReportForm.submit();
}
...
function Evenmore(obj,listname){	
	...
	if(comid!="" && comid!="%"){
		 ...
		 var url='<html:rewrite page="/zbReportAction.do"/>?method=toStorageIDList&comid='+comid;//跳转路径
