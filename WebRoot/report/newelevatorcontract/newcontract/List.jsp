...
<table width="98%"  border="0" cellpadding="0" cellspacing="0" align="center">
  <tr>
    ...
    <bean:write name="dateinfo" property="startdate"/>至<bean:write name="dateinfo" property="enddate"/>保养科新签定保养合同统计</font></div></td>
  </tr>
</table>
...
<tr>
  ...
  <logic:iterate id="element" name="report_list">
  	...
  	%>
  		...
  		<td nowrap><bean:write name="element" property="info"/></td>
  		...
  		<td nowrap><bean:write name="element" property="lotman"/></td>
  	</tr>
  </logic:iterate>
  </logic:present>
  <tr>
