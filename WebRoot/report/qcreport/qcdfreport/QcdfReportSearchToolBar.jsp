...
function searchMethod(){
	 ...
	 document.qcdfReportForm.genReport.value="";
	 document.qcdfReportForm.target = "_blank";
	 document.qcdfReportForm.submit();
...
function excelMethod(){
	...
	document.qcdfReportForm.genReport.value="Y";
	document.qcdfReportForm.target = "_blank";
	document.qcdfReportForm.submit();
}
...
function Evenmore(obj,listname){	
	...
	if(comid!="" && comid!="%"){
		 ...
		 var url='<html:rewrite page="/qcdfReportAction.do"/>?method=toStorageIDList&comid='+comid;//跳转路径
