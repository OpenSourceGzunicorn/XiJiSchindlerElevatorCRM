...
function searchMethod(){
	 ...
	 document.qcwtxReportForm.genReport.value="";
	 document.qcwtxReportForm.target = "_blank";
	 document.qcwtxReportForm.submit();
...
function excelMethod(){
	...
	document.qcwtxReportForm.genReport.value="Y";
	document.qcwtxReportForm.target = "_blank";
	document.qcwtxReportForm.submit();
}
...
function Evenmore(obj,listname){	
	...
	if(comid!="" && comid!="%"){
		 ...
		 var url='<html:rewrite page="/qcwtxReportAction.do"/>?method=toStorageIDList&comid='+comid;//跳转路径
