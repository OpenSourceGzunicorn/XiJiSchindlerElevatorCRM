...
function searchMethod(){
	 ...
	 document.qczdReportForm.genReport.value="";
	 document.qczdReportForm.target = "_blank";
	 document.qczdReportForm.submit();
...
function excelMethod(){
	...
	document.qczdReportForm.genReport.value="Y";
	document.qczdReportForm.target = "_blank";
	document.qczdReportForm.submit();
}
...
function Evenmore(obj,listname){	
	...
	if(comid!="" && comid!="%"){
		 ...
		 var url='<html:rewrite page="/qczdReportAction.do"/>?method=toStorageIDList&comid='+comid;//跳转路径
