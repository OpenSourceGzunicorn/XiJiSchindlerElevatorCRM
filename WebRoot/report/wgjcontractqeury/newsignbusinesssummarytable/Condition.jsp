...
<html:form action="/NewSignBusinessSummaryTableReportSearchAction.do?method=toSearchRecord">
	...
	<table width="98%" border="0"  cellpadding="0"	cellspacing="0" class="tb">
		<tr>
			...
			<td  width="80%">
				<html:text property="property(lotdates)" styleClass="Wdate" onclick="setday(this)" readonly="true" />
				至
				<html:text property="property(lotdatee)" styleClass="Wdate" onclick="setday(this)" readonly="true" />
			</td>
		</tr>
		<tr>
		<td width="20%" height="28" class="wordtd">
