...
<html:form action="/ReceivablesMaterialReportSearchAction.do?method=toSearchRecord">
	...
	<table width="98%" border="0"  cellpadding="0"	cellspacing="0" class="tb">
		...
		<tr>
			...
			<td  width="80%">
				<html:text property="property(predates)" onclick="setday(this)" styleClass="Wdate" readonly="true" />
				至
				<html:text property="property(predatee)" onclick="setday(this)" styleClass="Wdate" readonly="true" />
			</td>
		</tr>
		<tr>
			<td width="20%" height="28" class="wordtd">
				<div align="right">甲方单位名称：</div>
			</td>
			<td  width="80%">
				<html:text property="property(custname)" size="47"/>
			</td>
		</tr>
		<tr>
			<td width="20%" height="28" class="wordtd">
