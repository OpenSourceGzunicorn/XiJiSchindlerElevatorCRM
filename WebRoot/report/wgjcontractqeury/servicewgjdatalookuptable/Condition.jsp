...
<html:form action="/ServiceWGJDataLookupTableSearchAction.do?method=toSearchRecord">
	...
	<table width="98%" border="0"  cellpadding="0"	cellspacing="" class="tb">
		<tr>
		...
		<tr>
			...
			<td  width="80%">
				<html:text property="property(finishdates)" onclick="setday(this)" styleClass="Wdate" readonly="true" />
				至
				<html:text property="property(finishdatee)" onclick="setday(this)" styleClass="Wdate" readonly="true" />
			</td>
		</tr>
		<tr>
			<td width="20%" height="28" class="wordtd">
