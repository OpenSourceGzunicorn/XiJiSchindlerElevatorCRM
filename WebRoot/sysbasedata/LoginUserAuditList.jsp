...
<br>
	...
	<br>
    <table:table id="guiLoginUserAudit" name="loginuserauditList">
      <logic:iterate id="element" name="loginuserauditList">
        ...
        <a href="<html:rewrite page='/loginUserAuditAction.do'/>?method=toDisplayRecord&id=<bean:write name="element"  property="userid"/>"><bean:write name="element"  property="userid"/></a>
		</table:define>
