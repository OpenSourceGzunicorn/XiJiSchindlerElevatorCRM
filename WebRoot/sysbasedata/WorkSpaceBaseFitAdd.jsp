...
<br>
<html:errors/>
<html:form action="/workSpaceBaseFitAction.do?method=toAddRecord">
...
<table width="99%" border="0" align="center" cellpadding="2" cellspacing="0" class="tb">
  ...
  <tr>
    ...
    <td width="35%"> <html:text property="title" styleClass="default_input" size="64" maxlength="64" /> <font color="red">*</font></td>
  </tr>
  <tr>
    <td width="15%" class="wordtd"><bean:message key="workspacebasefit.link" />£∫</td>
    <td width="35%"> <html:text property="link" styleClass="default_input" size="64" maxlength="64"/> <font color="red">*</font></td>
  </tr>
  
   <tr>
    <td width="15%" class="wordtd"><bean:message key="workspacebasefit.tip" />£∫</td>
    <td width="35%"> <html:text property="tip" styleClass="default_input" size="64" maxlength="64" /> <font color="red">*</font></td>
  </tr>
  
  <tr>
    <td width="15%" class="wordtd"><bean:message key="DivId" />£∫</td>
    <td width="35%"> <html:text property="divid" styleClass="default_input" size="64" maxlength="64"/> <font color="red">*</font></td>
  </tr>
  <tr>
