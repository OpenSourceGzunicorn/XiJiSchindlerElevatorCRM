...
<br>
<html:errors/>
<html:form action="/Class1Action.do?method=toAddClass1">
<html:hidden property="isreturn"/>
<table width="100%" class="tb">
  
  <tr>
    <td width="20%" class="wordtd"><bean:message key="customer.placeid"/>:</td>
    <td width="80%"><html:text property="class1id" maxlength="255" styleClass="default_input"/><font color="red">*</font></td>
  </tr>
  <tr>
