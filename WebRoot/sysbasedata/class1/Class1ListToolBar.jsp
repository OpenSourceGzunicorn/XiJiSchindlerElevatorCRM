...
if(serveTableForm.ids)
{
	...
	if(l)
	{
		for(i=0;i<l;i++)
		{
			...
			{
				window.location = '<html:rewrite page="/Class1Action.do"/>?id='+document.serveTableForm.ids[i].value +'&method=toDisplayClass1';
				return;
			}
		}
		if(l >0)
	...
	{
		window.location = '<html:rewrite page="/Class1Action.do"/>?id='+document.serveTableForm.ids.value +'&method=toDisplayClass1';
	}
	else
	{
		alert("<bean:message key="javascript.role.alert2"/>");
...
//增加
function addMethod(){
window.location = '<html:rewrite page="/Class1Action.do"/>?method=toPrepareAddClass1';
}
//修改
...
if(serveTableForm.ids)
{
	...
	if(l)
	{
		for(i=0;i<l;i++)
		{
			...
			//alert(document.serveTableForm.ids[i].value);
				window.location = '<html:rewrite page="/Class1Action.do"/>?id='+document.serveTableForm.ids[i].value +'&method=toPrepareUpdateClass1';
				return;
			}
		}
		if(l >0)
	...
	{
		window.location = '<html:rewrite page="/Class1Action.do"/>?id='+document.serveTableForm.ids.value +'&method=toPrepareUpdateClass1';
	}
	else
	{
		alert("<bean:message key="javascript.role.alert1"/>");
...
if(serveTableForm.ids)
{
	...
	if(l)
	{
		for(i=0;i<l;i++)
		{
			if(document.serveTableForm.ids[i].checked == true)
			{
				...
				{
					window.location = '<html:rewrite page="/Class1Action.do"/>?id='+document.serveTableForm.ids[i].value +'&method=toDeleteClass1';
				}
				return;
			}
		}
	...
	else if(document.serveTableForm.ids.checked == true)
	{
		if(confirm("<bean:message key="javascript.role.deletecomfirm"/>"+document.serveTableForm.ids.value))
			{
				window.location = '<html:rewrite page="/Class1Action.do"/>?id='+document.serveTableForm.ids.value +'&method=toDeleteClass1';
			}
	}
	else
	{
