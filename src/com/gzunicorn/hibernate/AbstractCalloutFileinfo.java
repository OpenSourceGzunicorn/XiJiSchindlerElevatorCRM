...
/**
 * AbstractCalloutFileinfo entity provides the base persistence definition of
 * the CalloutFileinfo entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractCalloutFileinfo implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractCalloutFileinfo() {
	}

	/** minimal constructor */
	public AbstractCalloutFileinfo(String oldFileName, String newFileName,
	...
	/** full constructor */
	public AbstractCalloutFileinfo(String calloutMasterNo, String oldFileName,
