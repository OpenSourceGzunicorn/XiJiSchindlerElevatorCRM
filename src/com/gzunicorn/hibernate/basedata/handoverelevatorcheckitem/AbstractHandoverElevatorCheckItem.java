...
/**
 * AbstractHandoverElevatorCheckItem entity provides the base persistence
 * definition of the HandoverElevatorCheckItem entity. @author MyEclipse
 * Persistence Tools
 */

public abstract class AbstractHandoverElevatorCheckItem implements
		java.io.Serializable {

	// Fields

	private HandoverElevatorCheckItemId id;
	...
	/** default constructor */
	public AbstractHandoverElevatorCheckItem() {
	}

	/** minimal constructor */
	public AbstractHandoverElevatorCheckItem(HandoverElevatorCheckItemId id,
	...
	public HandoverElevatorCheckItemId getId() {
		return this.id;
	}

	public void setId(HandoverElevatorCheckItemId id) {
		this.id = id;
	}
