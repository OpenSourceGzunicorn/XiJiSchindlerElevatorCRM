...
/**
 * AbstractHotlineMotherboardType entity provides the base persistence
 * definition of the HotlineMotherboardType entity. @author MyEclipse
 * Persistence Tools
 */

public abstract class AbstractHotlineMotherboardType implements
	...
	/** default constructor */
	public AbstractHotlineMotherboardType() {
	}

	/** minimal constructor */
	public AbstractHotlineMotherboardType(String hmtId, String hmtName,
			String enabledFlag, String operId, String operDate) {
		this.hmtId = hmtId;
		this.hmtName = hmtName;
	...
	public void setHmtName(String hmtName) {
		this.hmtName = hmtName;
	}
