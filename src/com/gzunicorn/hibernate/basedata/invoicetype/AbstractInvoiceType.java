...
/**
 * AbstractInvoiceType entity provides the base persistence definition of the
 * InvoiceType entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractInvoiceType implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractInvoiceType() {
	}

	/** minimal constructor */
	public AbstractInvoiceType(String inTypeId, String inTypeName,
