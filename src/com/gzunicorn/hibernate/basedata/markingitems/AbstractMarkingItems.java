...
/**
 * AbstractMarkingItems entity provides the base persistence definition of the
 * MarkingItems entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractMarkingItems implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractMarkingItems() {
	}

	/** minimal constructor */
	public AbstractMarkingItems(String mtId, String mtName, Double fraction,
