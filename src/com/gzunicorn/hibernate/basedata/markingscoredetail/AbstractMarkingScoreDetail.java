...
/**
 * AbstractMarkingScoreDetail entity provides the base persistence definition of
 * the MarkingScoreDetail entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractMarkingScoreDetail implements
	...
	/** default constructor */
	public AbstractMarkingScoreDetail() {
	}

	/** minimal constructor */
	public AbstractMarkingScoreDetail(
			MarkingScore markingScore,
			String detailId, String detailName,String msId
			) {
	...
	public AbstractMarkingScoreDetail(
		 ...
		 String r1, String r2, String r3, String r4, String r5,
			Double r6, Double r7, Double r8, Integer r9, Integer r10) {
		this.markingScore=markingScore;
		this.detailId = detailId;
		this.detailName = detailName;
