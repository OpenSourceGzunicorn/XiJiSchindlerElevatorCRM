...
/**
 * AbstractOfficeContractTypes entity provides the base persistence definition
 * of the OfficeContractTypes entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractOfficeContractTypes implements
	...
	/** default constructor */
	public AbstractOfficeContractTypes() {
	}

	/** minimal constructor */
	public AbstractOfficeContractTypes(String octId, String octName,
	...
	public void setOctName(String octName) {
		this.octName = octName;
	}
