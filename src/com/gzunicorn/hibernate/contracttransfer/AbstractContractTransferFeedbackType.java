...
/**
 * AbstractContractTransferFeedbackType entity provides the base persistence
 * definition of the ContractTransferFeedbackType entity. @author MyEclipse
 * Persistence Tools
 */

public abstract class AbstractContractTransferFeedbackType implements
	...
	/** default constructor */
	public AbstractContractTransferFeedbackType() {
	}

	/** minimal constructor */
	public AbstractContractTransferFeedbackType(String feedbackTypeId,
