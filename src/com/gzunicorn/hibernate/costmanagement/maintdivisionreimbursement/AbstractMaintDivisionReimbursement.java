...
/**
 * AbstractMaintDivisionReimbursement entity provides the base persistence
 * definition of the MaintDivisionReimbursement entity. @author MyEclipse
 * Persistence Tools
 */

public abstract class AbstractMaintDivisionReimbursement implements
	...
	private Integer r9;
	private Integer r10;
	private Set maintDivisionReimbursementDetails = new HashSet(0);

	// Constructors

	/** default constructor */
	public AbstractMaintDivisionReimbursement() {
	}

	/** minimal constructor */
	public AbstractMaintDivisionReimbursement(String jnlno, String reimburType,
	...
	/** full constructor */
	public AbstractMaintDivisionReimbursement(String jnlno,
		...
		this.r9 = r9;
		this.r10 = r10;
		this.maintDivisionReimbursementDetails = maintDivisionReimbursementDetails;
	}
	...
	public Set getMaintDivisionReimbursementDetails() {
		return this.maintDivisionReimbursementDetails;
	}

	public void setMaintDivisionReimbursementDetails(
			Set maintDivisionReimbursementDetails) {
		this.maintDivisionReimbursementDetails = maintDivisionReimbursementDetails;
	}
