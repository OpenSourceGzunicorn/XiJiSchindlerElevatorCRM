...
/**
 * AbstractMaintDivisionReimbursementDetail entity provides the base persistence
 * definition of the MaintDivisionReimbursementDetail entity. @author MyEclipse
 * Persistence Tools
 */

public abstract class AbstractMaintDivisionReimbursementDetail implements
		java.io.Serializable {

	// Fields

	private Integer rowid;
	private MaintDivisionReimbursement maintDivisionReimbursement;
	...
	/** default constructor */
	public AbstractMaintDivisionReimbursementDetail() {
	}

	/** minimal constructor */
	public AbstractMaintDivisionReimbursementDetail(String maintContractNo,
	...
	public AbstractMaintDivisionReimbursementDetail(
		...
		this.maintDivisionReimbursement = maintDivisionReimbursement;
		this.maintContractNo = maintContractNo;
		this.num = num;
		this.money = money;
		this.rem = rem;
	...
	public MaintDivisionReimbursement getMaintDivisionReimbursement() {
		return this.maintDivisionReimbursement;
	}

	public void setMaintDivisionReimbursement(
			MaintDivisionReimbursement maintDivisionReimbursement) {
		this.maintDivisionReimbursement = maintDivisionReimbursement;
	}
