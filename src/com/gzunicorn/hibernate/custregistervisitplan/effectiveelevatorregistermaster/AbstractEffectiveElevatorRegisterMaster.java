...
/**
 * AbstractEffectiveElevatorRegisterMaster entity provides the base persistence
 * definition of the EffectiveElevatorRegisterMaster entity. @author MyEclipse
 * Persistence Tools
 */

public abstract class AbstractEffectiveElevatorRegisterMaster implements
	...
	/** default constructor */
	public AbstractEffectiveElevatorRegisterMaster() {
	}

	/** minimal constructor */
	public AbstractEffectiveElevatorRegisterMaster(String billno,
			String companyId, String contacts, String contactPhone,
			String ministerHandle, String operId, String operDate) {
		this.billno = billno;
	...
	public AbstractEffectiveElevatorRegisterMaster(String billno,
			String companyId, String contacts, String contactPhone,
			String ministerHandle, String handleId, String handleDate,
			String handleResult, String returnResult, String returnRem,
			...
			Double r9, Double r10,String companyName) {
		this.companyName=companyName;
		this.billno = billno;
		this.companyId = companyId;
		this.contacts = contacts;
