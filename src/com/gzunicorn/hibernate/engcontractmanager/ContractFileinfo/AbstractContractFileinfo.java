...
/**
 * AbstractContractFileinfo entity provides the base persistence definition of
 * the ContractFileinfo entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractContractFileinfo implements java.io.Serializable {

	// Fields

	private Integer fileSid;
	private String busTable;
	private String materSid;
	...
	/** default constructor */
	public AbstractContractFileinfo() {
	}

	/** minimal constructor */
	public AbstractContractFileinfo(String busTable, String materSid,
	...
	public String getMaterSid() {
		return this.materSid;
	}

	public void setMaterSid(String materSid) {
		this.materSid = materSid;
	}
