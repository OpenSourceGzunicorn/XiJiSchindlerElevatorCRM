...
/**
 * AbstractMaintContractDelayDetail entity provides the base persistence
 * definition of the MaintContractDelayDetail entity. @author MyEclipse
 * Persistence Tools
 */

public abstract class AbstractMaintContractDelayDetail implements
	...
	/** default constructor */
	public AbstractMaintContractDelayDetail() {
	}

	/** minimal constructor */
	public AbstractMaintContractDelayDetail(String jnlno, Integer rowid,
			String delayEdate) {
		this.jnlno = jnlno;
		this.rowid = rowid;
