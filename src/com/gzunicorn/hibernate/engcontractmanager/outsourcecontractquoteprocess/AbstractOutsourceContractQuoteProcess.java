package com.gzunicorn.hibernate.engcontractmanager.outsourcecontractquoteprocess;

/**
 * AbstractOutsourceContractQuoteProcess entity provides the base persistence
 * definition of the OutsourceContractQuoteProcess entity. @author MyEclipse
 * Persistence Tools
 */

public abstract class AbstractOutsourceContractQuoteProcess implements
	...
	/** default constructor */
	public AbstractOutsourceContractQuoteProcess() {
	}

	/** minimal constructor */
	public AbstractOutsourceContractQuoteProcess(String billNo, Integer taskId,
