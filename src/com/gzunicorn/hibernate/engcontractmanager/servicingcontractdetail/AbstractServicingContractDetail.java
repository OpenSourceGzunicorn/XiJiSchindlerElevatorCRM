...
/**
 * AbstractServicingContractDetail entity provides the base persistence
 * definition of the ServicingContractDetail entity. @author MyEclipse
 * Persistence Tools
 */

public abstract class AbstractServicingContractDetail implements
		java.io.Serializable {

	// Fields

	private Integer rowid;
	private ServicingContractMaster servicingContractMaster;
	...
	/** default constructor */
	public AbstractServicingContractDetail() {
	}

	/** minimal constructor */
	public AbstractServicingContractDetail(String elevatorNo,
	...
	public AbstractServicingContractDetail(
		...
		this.servicingContractMaster = servicingContractMaster;
		this.elevatorNo = elevatorNo;
		this.salesContractNo = salesContractNo;
		this.projectName = projectName;
		this.contents = contents;
	...
	public ServicingContractMaster getServicingContractMaster() {
		return this.servicingContractMaster;
	}

	public void setServicingContractMaster(
			ServicingContractMaster servicingContractMaster) {
		this.servicingContractMaster = servicingContractMaster;
	}
