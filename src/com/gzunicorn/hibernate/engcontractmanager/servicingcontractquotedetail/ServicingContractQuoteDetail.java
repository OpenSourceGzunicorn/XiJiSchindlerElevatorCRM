package com.gzunicorn.hibernate.engcontractmanager.servicingcontractquotedetail;

import com.gzunicorn.hibernate.engcontractmanager.servicingcontractquotemaster.ServicingContractQuoteMaster;

/**
 * ServicingContractQuoteDetail entity. @author MyEclipse Persistence Tools
 */
public class ServicingContractQuoteDetail extends
		AbstractServicingContractQuoteDetail implements java.io.Serializable {

	// Constructors

	/** default constructor */
	public ServicingContractQuoteDetail() {
	}
	...
	public ServicingContractQuoteDetail(
			...
			String contents) {
		super(servicingContractQuoteMaster, elevatorNo, salesContractNo,
