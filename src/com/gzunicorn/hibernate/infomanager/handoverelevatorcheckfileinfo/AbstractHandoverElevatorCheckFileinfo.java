...
/**
 * AbstractHandoverElevatorCheckFileinfo entity provides the base persistence
 * definition of the HandoverElevatorCheckFileinfo entity. @author MyEclipse
 * Persistence Tools
 */

public abstract class AbstractHandoverElevatorCheckFileinfo implements
		java.io.Serializable {

	// Fields

	private Integer fileSid;
	private HandoverElevatorCheckItemRegister handoverElevatorCheckItemRegister;
	...
	/** default constructor */
	public AbstractHandoverElevatorCheckFileinfo() {
	}

	/** minimal constructor */
	public AbstractHandoverElevatorCheckFileinfo(String oldFileName,
	...
	public AbstractHandoverElevatorCheckFileinfo(
		...
		this.handoverElevatorCheckItemRegister = handoverElevatorCheckItemRegister;
		this.oldFileName = oldFileName;
		this.newFileName = newFileName;
		this.filePath = filePath;
		this.fileFormat = fileFormat;
	...
	public HandoverElevatorCheckItemRegister getHandoverElevatorCheckItemRegister() {
		return this.handoverElevatorCheckItemRegister;
	}

	public void setHandoverElevatorCheckItemRegister(
			HandoverElevatorCheckItemRegister handoverElevatorCheckItemRegister) {
		this.handoverElevatorCheckItemRegister = handoverElevatorCheckItemRegister;
	}
