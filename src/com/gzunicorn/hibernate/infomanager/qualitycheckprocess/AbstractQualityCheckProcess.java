...
/**
 * AbstractQualityCheckProcess entity provides the base persistence definition
 * of the QualityCheckProcess entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractQualityCheckProcess implements
	...
	/** default constructor */
	public AbstractQualityCheckProcess() {
	}

	/** minimal constructor */
	public AbstractQualityCheckProcess(Integer taskId, String taskName,
	...
	/** full constructor */
	public AbstractQualityCheckProcess(String billno, Integer taskId,
