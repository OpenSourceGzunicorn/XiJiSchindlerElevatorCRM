...
/**
 * AbstractWbfileinfo entity provides the base persistence definition of the
 * Wbfileinfo entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractWbfileinfo implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractWbfileinfo() {
	}

	/** minimal constructor */
	public AbstractWbfileinfo(String busTable, String materSid,
