...
//		this.setNavigation(request, "navigator.base.province.list");
		request.setAttribute("navigator.location","区域维护-省份 >> 查询列表");
...
//		this.setNavigation(request, "navigator.base.province.view");
		request.setAttribute("navigator.location","区域维护-省份 >> 查看");
...
//		this.setNavigation(request, "navigator.base.province.add");
		request.setAttribute("navigator.location","区域维护-省份 >> 添加");
...
//		java.util.List result = new java.util.ArrayList();
		try{
			cfresult=bd.getCountryList("Y"); //国家
		}
		catch (Exception e) {
...
//		this.setNavigation(request, "navigator.base.province.modify");
		request.setAttribute("navigator.location","区域维护-省份 >> 修改");
