...
public class AccountsPayableAuditAction extends DispatchAction {

	Log log = LogFactory.getLog(AccountsPayableAuditAction.class);
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		SysRightsUtil.filterModuleRight(request, response,
				SysRightsUtil.NODE_ID_FORWARD + "accountspayableaudit", null);
		/** **********结束用户权限过滤*********** */
	...
	public ActionForward toSearchRecord(ActionMapping mapping, ActionForm form,
		...
		request.setAttribute("navigator.location","应付款审核 >> 查询列表");		
		...
		if (tableForm.getProperty("genReport") != null
			...
			HTMLTableCache cache = new HTMLTableCache(session, "accountsPayableAuditList");

			DefaultHTMLTable table = new DefaultHTMLTable();
			table.setMapping("fAccountsPayableAudit");
			...
			try {
                ...
                String sql = "select cpm,c.companyName,compay.comfullname,rn.recName from ContractPayablesMaster cpm,Customer c,Company compay,ReceivablesName rn where rn.recId=cpm.recName and compay.comid=cpm.maintDivision and cpm.companyId=c.companyId and cpm.submitType='Y'";
				...
				session.setAttribute("accountsPayableAuditList", table);
				// 分部下拉框列表
			...
			forward = mapping.findForward("accountsPayableAuditList");
		}
		return forward;
	}
	...
	public ActionForward toPrepareUpdateRecord(ActionMapping mapping,
		...
		request.setAttribute("navigator.location","应付款审核 >> 查看与审核");	
		...
		forward = mapping.findForward("accountsPayableAuditModify");
	...
	public ActionForward toUpdateRecord(ActionMapping mapping, ActionForm form,
		...
		if (id != null && !id.equals("")) {
			...
			try {
				...
				ContractPayablesMaster master = (ContractPayablesMaster) hs
						.get(ContractPayablesMaster.class, id);
	...
	public ActionForward toDisplayRecord(ActionMapping mapping,
		...
		forward = mapping.findForward("accountsPayableAuditDisplay");
		return forward;
	}
