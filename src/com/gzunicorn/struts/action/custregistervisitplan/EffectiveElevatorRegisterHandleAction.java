...
public class EffectiveElevatorRegisterHandleAction extends DispatchAction {

	Log log = LogFactory.getLog(EffectiveElevatorRegisterHandleAction.class);
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		SysRightsUtil.filterModuleRight(request, response,
				SysRightsUtil.NODE_ID_FORWARD + "effectiveelevatorregisterhandle", null);
		/** **********结束用户权限过滤*********** */
	...
	public ActionForward toSearchRecord(ActionMapping mapping, ActionForm form,
		...
		request.setAttribute("navigator.location", "有价值客户回访处理>> 查询列表");
...
//			String isProblem = (String) dform.get("isProblem");
			...
			try {
				...
				String sql = " select * from "
						+ "(select c1.ReOrder,c1.ReMark,c1.CompanyName,c1.Contacts,c1.ContactPhone,c2.OperDate,c2.handleID,"
						+ "c2.handleResult,c2.ReturnResult,c2.billno,c2.MinisterHandle,isnull(c2.rem,'') rem1 "
			...
			forward = mapping.findForward("effectiveElevatorRegisterHandleList");
	...
	public ActionForward toPrepareUpdateRecord(ActionMapping mapping,
		...
		request.setAttribute("navigator.location","有价值客户回访处理 >> 处理");
		DynaActionForm dform = (DynaActionForm) form;
		...
		if (id != null) {
			...
			forward = mapping.findForward("effectiveElevatorRegisterHandleModify");
}
