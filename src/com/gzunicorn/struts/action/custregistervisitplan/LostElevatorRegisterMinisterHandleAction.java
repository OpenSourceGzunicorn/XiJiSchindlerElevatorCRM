...
public class LostElevatorRegisterMinisterHandleAction extends DispatchAction {

	Log log = LogFactory.getLog(LostElevatorRegisterMinisterHandleAction.class);
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		SysRightsUtil.filterModuleRight(request, response,
				SysRightsUtil.NODE_ID_FORWARD + "lostelevatorregisterministerhandle", null);
		/** **********结束用户权限过滤*********** */
	...
	public ActionForward toSearchRecord(ActionMapping mapping, ActionForm form,
		...
		request.setAttribute("navigator.location", "丢梯客户回访分部长处理>> 查询列表");
		...
		String action = dform.toString();
			...
			try {
				...
				String sql = "select * from "
						...
						+ "on c1.CompanyID=c2.CompanyID) as c3 where isnull(c3.handleId,'')='' and c3.MinisterHandle like 'Y' ";				
			...
			forward = mapping.findForward("lostElevatorRegisterMinisterHandleList");
	...
	public ActionForward toPrepareUpdateRecord(ActionMapping mapping,
		...
		request.setAttribute("navigator.location","丢梯客户回访分部长处理 >> 处理");
		DynaActionForm dform = (DynaActionForm) form;
		...
		if (id != null) {
			...
			forward = mapping.findForward("lostElevatorRegisterMinisterHandleModify");
}
