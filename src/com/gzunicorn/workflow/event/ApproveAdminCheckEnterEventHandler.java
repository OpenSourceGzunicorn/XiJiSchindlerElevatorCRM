...
public class ApproveAdminCheckEnterEventHandler implements ActionHandler{
	...
	public void execute(ExecutionContext context) throws Exception {
		...
		map.put("checkclass1id",pb.getPro("checkclass1id"));
		List userList=wfu.getNodeAdminCheckActors(nodeid,RefUserId,pb.getApplydeptid(),"0",map);
