...
public class ApproveAdminCommissionerEnterEventHandler implements ActionHandler{
	...
	public void execute(ExecutionContext context) throws Exception {
		...
		List userList=wfu.getNodeAdminCommissionerActors(nodeid,RefUserId,pb.getApplydeptid(),"0",map);
