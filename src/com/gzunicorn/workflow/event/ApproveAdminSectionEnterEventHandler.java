...
public class ApproveAdminSectionEnterEventHandler implements ActionHandler{
	...
	public void execute(ExecutionContext context) throws Exception {
		...
		List userList=wfu.getNodeAdminSectionActors(nodeid,RefUserId,pb.getApplydeptid(),"0",map);
